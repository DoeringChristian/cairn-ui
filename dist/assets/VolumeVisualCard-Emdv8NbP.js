import{j as s,y as fe,r as g,d as ve,L as ne,a4 as xe,J as he,Q as be}from"./parse-overlay-Ba3Wl3I7.js";import{br as ge,J as X,b8 as k,bk as T,b9 as K,z as Me,p as ye}from"./index-C6PQZID0.js";import{u as we,n as Ce,R as Se,U as ie,o as L,C as I,p as _,q as De,s as je,G as Te,t as Pe,l as Oe,S as Ae,v as Ve,w as ke,d as se,e as re,f as Re,V as B,x as Ie,h as Ee,i as Fe,r as ze,O as ee,j as Le}from"./OffscreenComparePanes-DwaQc2Fa.js";import"./parse-npz-Du4h7wjo.js";const Ue={dark:856343,light:16185594},ae=256;let R=null;function Ne(){if(R!==null)return R;try{const o=document.createElement("canvas").getContext("webgl2");if(o){const t=o.getExtension("WEBGL_lose_context");t==null||t.loseContext()}R=!!o}catch{R=!1}return R}function _e(e,o,t){const n=t-o||1,a=new Uint8Array(e.length);for(let r=0;r<e.length;r++){const i=(e[r]-o)/n;a[r]=Math.max(0,Math.min(255,Math.round(i*255)))}return a}function oe(e){const o=ve(e),t=new Uint8Array(256*4);for(let a=0;a<256;a++)t[a*4]=o[a*3],t[a*4+1]=o[a*3+1],t[a*4+2]=o[a*3+2],t[a*4+3]=255;const n=new Ve(t,256,1,ke,ie);return n.minFilter=L,n.magFilter=L,n.wrapS=I,n.wrapT=I,n.needsUpdate=!0,n}const Xe=`precision highp float;
