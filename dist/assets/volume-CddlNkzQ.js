import{j as m,K as ie,r as h,g as se,L as W}from"./PlotHost-D2UyXaoG.js";import{u as re,n as le,R as ue,U as H,o as z,C as S,p as A,q as ce,s as me,G as de,t as fe,l as pe,S as ve,v as xe,w as he,V as O,e as ge,g as $,h as q,i as be,x as ye}from"./ViewportPlaceholder-UATdHWsQ.js";const De={dark:856343,light:16185594},F=256;let T=null;function Me(){if(T!==null)return T;try{const t=document.createElement("canvas").getContext("webgl2");if(t){const a=t.getExtension("WEBGL_lose_context");a==null||a.loseContext()}T=!!t}catch{T=!1}return T}function we(e,t,a){const n=a-t||1,i=new Uint8Array(e.length);for(let l=0;l<e.length;l++){const u=(e[l]-t)/n;i[l]=Math.max(0,Math.min(255,Math.round(u*255)))}return i}function G(e){const t=se(e),a=new Uint8Array(256*4);for(let i=0;i<256;i++)a[i*4]=t[i*3],a[i*4+1]=t[i*3+1],a[i*4+2]=t[i*3+2],a[i*4+3]=255;const n=new xe(a,256,1,he,H);return n.minFilter=z,n.magFilter=z,n.wrapS=S,n.wrapT=S,n.needsUpdate=!0,n}const Te=`precision highp float;
