import{w as a,r as p,a9 as Fe,u as Be,a as Le,a5 as ze,a6 as Ve,b as xe,d as Ue,e as pe,q as Xe,f as Ge,i as te,m as qe,j as $e,k as We,l as He,t as ce,s as Se,C as Ke,x as V,J as F,T as Qe,A as Ye,B as Ze,D as Je,R as ea,F as ue,G as ye,M as _e,a0 as Te,a7 as aa,a8 as ta,h as na,E as sa,a2 as oa,a3 as ia}from"./index-BAJt8X8U.js";import{u as ra,j as la,R as ca,U as Pe,k as ae,C as X,V as de,l as ua,m as da,G as ma,n as pa,h as fa,o as xa,p as ha,f as va,r as ga,O as ba,d as Ma,q as Ca,s as Sa}from"./diff-BjgqzXmm.js";import{u as ya,C as ja}from"./CompareSettingsPanel-CbG29pZF.js";const Da={dark:856343,light:16185594},je=256;let U=null;function _a(){if(U!==null)return U;try{const n=document.createElement("canvas").getContext("webgl2");if(n){const s=n.getExtension("WEBGL_lose_context");s==null||s.loseContext()}U=!!n}catch{U=!1}return U}function Ta({className:o}){return a.jsx("div",{className:o??"relative h-full w-full",children:a.jsxs("div",{className:"flex h-full w-full flex-col items-center justify-center gap-1 rounded bg-bg-hover p-4 text-center",children:[a.jsx("div",{className:"text-sm font-semibold text-fg",children:"WebGL2 unavailable"}),a.jsx("div",{className:"text-xs text-fg-muted",children:"Volume rendering needs WebGL2 (raymarched 3D textures), which this browser or GPU doesn't support."})]})})}function Pa(o,n,s){const d=s-n||1,u=new Uint8Array(o.length);for(let x=0;x<o.length;x++){const l=(o[x]-n)/d;u[x]=Math.max(0,Math.min(255,Math.round(l*255)))}return u}function De(o){const n=Fe(o),s=new Uint8Array(256*4);for(let u=0;u<256;u++)s[u*4]=n[u*3],s[u*4+1]=n[u*3+1],s[u*4+2]=n[u*3+2],s[u*4+3]=255;const d=new xa(s,256,1,ha,Pe);return d.minFilter=ae,d.magFilter=ae,d.wrapS=X,d.wrapT=X,d.needsUpdate=!0,d}const Ra=`precision highp float;
