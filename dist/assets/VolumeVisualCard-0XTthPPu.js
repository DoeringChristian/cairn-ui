import{j as s,y as fe,r as g,d as ve,L as ne,a4 as xe,Q as he,X as be}from"./parse-overlay-DzFpWpKB.js";import{I as X,b6 as k,bo as T,b7 as J,y as ge,o as Me}from"./index-136pTSnt.js";import{u as ye,o as we,R as Ce,U as ie,p as L,C as I,q as _,s as Se,t as De,G as je,v as Te,m as Pe,S as Oe,w as Ae,x as Ve,d as se,e as re,f as ke,V as B,y as Re,h as Ie,i as Ee,j as Fe,r as ze,O as ee,k as Le}from"./VisualContentCard-DIi8T_AQ.js";import"./parse-npz-B7JUnFpw.js";import"./camera-sync-B-WDowF9.js";const Ue={dark:856343,light:16185594},ae=256;let R=null;function Ne(){if(R!==null)return R;try{const o=document.createElement("canvas").getContext("webgl2");if(o){const t=o.getExtension("WEBGL_lose_context");t==null||t.loseContext()}R=!!o}catch{R=!1}return R}function _e(e,o,t){const n=t-o||1,a=new Uint8Array(e.length);for(let r=0;r<e.length;r++){const i=(e[r]-o)/n;a[r]=Math.max(0,Math.min(255,Math.round(i*255)))}return a}function oe(e){const o=ve(e),t=new Uint8Array(256*4);for(let a=0;a<256;a++)t[a*4]=o[a*3],t[a*4+1]=o[a*3+1],t[a*4+2]=o[a*3+2],t[a*4+3]=255;const n=new Ae(t,256,1,Ve,ie);return n.minFilter=L,n.magFilter=L,n.wrapS=I,n.wrapT=I,n.needsUpdate=!0,n}const Xe=`precision highp float;
