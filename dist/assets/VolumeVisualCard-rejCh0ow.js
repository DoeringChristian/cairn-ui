import{j as i,a_ as ve,r as g,d as xe,aw as ie,av as he,A as be,i as ge,n as Me}from"./parse-overlay-DVkN5vTG.js";import{bo as ye,J as X,b5 as I,bh as T,b6 as ee,z as we,p as Se}from"./index-Kyeo-p3I.js";import{u as Ce,o as De,R as je,U as se,p as L,C as F,q as B,s as Te,t as Pe,G as Ae,v as Oe,m as Ve,S as ke,w as Re,x as Ie,d as re,e as le,f as Ee,V as _,y as Fe,h as Ne,i as ze,j as Ue,r as Le,O as ae,k as _e}from"./OffscreenComparePanes-C2TTohHp.js";import"./parse-npz-CwUs9V2k.js";const Be={dark:856343,light:16185594},oe=256;let E=null;function Xe(){if(E!==null)return E;try{const e=document.createElement("canvas").getContext("webgl2");if(e){const t=e.getExtension("WEBGL_lose_context");t==null||t.loseContext()}E=!!e}catch{E=!1}return E}function Ge(a,e,t){const n=t-e||1,o=new Uint8Array(a.length);for(let r=0;r<a.length;r++){const s=(a[r]-e)/n;o[r]=Math.max(0,Math.min(255,Math.round(s*255)))}return o}function te(a){const e=xe(a),t=new Uint8Array(256*4);for(let o=0;o<256;o++)t[o*4]=e[o*3],t[o*4+1]=e[o*3+1],t[o*4+2]=e[o*3+2],t[o*4+3]=255;const n=new Re(t,256,1,Ie,se);return n.minFilter=L,n.magFilter=L,n.wrapS=F,n.wrapT=F,n.needsUpdate=!0,n}const We=`precision highp float;
