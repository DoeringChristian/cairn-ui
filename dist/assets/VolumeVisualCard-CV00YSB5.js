import{j as i,b7 as ve,r as g,d as xe,aF as ie,aE as he,O as be,l as ge}from"./parse-overlay-wXHWgA_X.js";import{bo as Me,J as X,b5 as E,bh as T,b6 as ee,z as ye,p as we}from"./index-DjH8bBs-.js";import{u as Se,o as Ce,R as De,U as se,p as L,C as I,q as B,s as je,t as Te,G as Pe,v as Ae,m as Oe,S as Ve,w as ke,x as Re,d as re,e as le,f as Ee,V as _,y as Fe,h as Ie,i as ze,j as Ne,r as Ue,O as ae,k as Le}from"./OffscreenComparePanes-BqtevPRw.js";const _e={dark:856343,light:16185594},oe=256;let F=null;function Be(){if(F!==null)return F;try{const e=document.createElement("canvas").getContext("webgl2");if(e){const n=e.getExtension("WEBGL_lose_context");n==null||n.loseContext()}F=!!e}catch{F=!1}return F}function Xe(o,e,n){const t=n-e||1,a=new Uint8Array(o.length);for(let r=0;r<o.length;r++){const s=(o[r]-e)/t;a[r]=Math.max(0,Math.min(255,Math.round(s*255)))}return a}function ne(o){const e=xe(o),n=new Uint8Array(256*4);for(let a=0;a<256;a++)n[a*4]=e[a*3],n[a*4+1]=e[a*3+1],n[a*4+2]=e[a*3+2],n[a*4+3]=255;const t=new ke(n,256,1,Re,se);return t.minFilter=L,t.magFilter=L,t.wrapS=I,t.wrapT=I,t.needsUpdate=!0,t}const Ge=`precision highp float;
