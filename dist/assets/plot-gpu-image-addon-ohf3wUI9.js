var pa=Object.defineProperty;var ha=(e,t,r)=>t in e?pa(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var k=(e,t,r)=>ha(e,typeof t!="symbol"?t+"":t,r);import{aw as ga,ax as ma,ay as On,az as ba,aA as va,aB as Un,aC as wa,aD as xa,aE as Ea,aF as ya,aG as In,aH as Sa,aI as Ln,aJ as Ma,aK as Ta,aL as kn,aM as Ra,aN as Da,aO as Pa,aP as Ca,aQ as Ba,aR as Aa,aS as Fn,H as wr,aT as _a,aU as Ga,aV as Oe,aW as xr,aX as Oa,aY as Ua,aZ as Ia,a_ as Nn,a$ as La,b0 as ka,b1 as Fa,b2 as tn,b3 as Na,b4 as Er,b5 as yr,b6 as Sr,b7 as za,r as b,b8 as xt,b9 as Ve,ba as Wa,bb as $a,at as Ke,bc as Va,bd as Ha,be as Ka,u as Ya,bf as ja,bg as Et,bh as qa,bi as Xa,an as Za,bj as yt,bk as Qa,bl as Ja,bm as ct,bn as es,bo as ts,bp as ns,m as Mr,bq as rs,br as as,bs as ss,bt as is,bu as os,bv as cs,bw as zn,bx as Wn,by as us,bz as ls,bA as St,bB as ds,bC as fs,l as Tr,bD as $n,bE as ps,j as te,v as hs,L as Vn,C as gs,q as ms,bF as bs,bG as vs,bH as ws,bI as xs,bJ as Es,bK as ys,bL as Ss,bM as Hn,bN as Ms,P as Xt,bO as Ts,bP as Rs,bQ as Ds,bR as Ps,a2 as Cs,bS as Kn,bT as Ge,bU as Bs,bV as As,bW as _s}from"./parse-overlay-Dax7NZ2Y.js";import{aW as Gs,aX as Os,aY as Us}from"./index-C-3lJHz4.js";import{r as Rr,n as Is,w as Ls}from"./capability-notice-jIjs9CwC.js";import"./parse-npz-BWaJKlSe.js";const nn=GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.COPY_SRC;function Dr(e,t){const r=navigator.gpu.getPreferredCanvasFormat();return e.configure({device:t,format:r,alphaMode:"premultiplied",usage:nn}),{hdr:!1,format:r}}function ks(e,t){try{return e.configure({device:t,format:"rgba16float",colorSpace:"display-p3",toneMapping:{mode:"extended"},alphaMode:"premultiplied",usage:nn}),{hdr:!0,format:"rgba16float",colorSpace:"display-p3",toneMappingMode:"extended"}}catch{try{return e.configure({device:t,format:"rgba16float",colorSpace:"display-p3",toneMapping:{mode:"standard"},alphaMode:"premultiplied",usage:nn}),{hdr:!0,format:"rgba16float",colorSpace:"display-p3",toneMappingMode:"standard"}}catch{return Dr(e,t)}}}const Rt=256,rn=new Map,an=new Map;function Pr(e){if(rn.has(e.id))throw new Error(`registerReduceOp: duplicate op id "${e.id}"`);rn.set(e.id,e)}function Cr(e){if(an.has(e.id))throw new Error(`registerReduceProgram: duplicate program id "${e.id}"`);an.set(e.id,e)}function Yn(e){return rn.get(e)}function jn(e){return an.get(e)}Pr({id:"sum",wgslIdentity:"0.0",wgslCombine:(e,t)=>`${e} + ${t}`,cpuIdentity:0,cpuCombine:(e,t)=>e+t,finalize:e=>e});Pr({id:"mean",wgslIdentity:"0.0",wgslCombine:(e,t)=>`${e} + ${t}`,cpuIdentity:0,cpuCombine:(e,t)=>e+t,finalize:(e,t)=>t>0?e/t:NaN});Cr({id:"channel",textureArity:1,lanes:1,perPixelWGSL:`
