import{o,r as y,bO as me,bH as G,bI as de,U as L,bj as I,bv as T,bk as fe,H as pe,x as xe,bM as ve}from"./index-BLOwh7Wd.js";import{u as he,n as ge,R as be,U as te,o as z,C as R,V as U,p as ye,q as Me,G as we,s as Se,l as Ce,S as je,t as De,v as Te,d as ie,e as oe,f as Ae,w as Ve,h as ke,i as Oe,r as Ne,O as K,j as Pe}from"./diff-DWbU61kC.js";const Re={dark:856343,light:16185594},J=256;let P=null;function Ee(){if(P!==null)return P;try{const e=document.createElement("canvas").getContext("webgl2");if(e){const i=e.getExtension("WEBGL_lose_context");i==null||i.loseContext()}P=!!e}catch{P=!1}return P}function Fe({className:a}){return o.jsx("div",{className:a??"relative h-full w-full",children:o.jsxs("div",{className:"flex h-full w-full flex-col items-center justify-center gap-1 rounded bg-bg-hover p-4 text-center",children:[o.jsx("div",{className:"text-sm font-semibold text-fg",children:"WebGL2 unavailable"}),o.jsx("div",{className:"text-xs text-fg-muted",children:"Volume rendering needs WebGL2 (raymarched 3D textures), which this browser or GPU doesn't support."})]})})}function Ie(a,e,i){const n=i-e||1,t=new Uint8Array(a.length);for(let r=0;r<a.length;r++){const s=(a[r]-e)/n;t[r]=Math.max(0,Math.min(255,Math.round(s*255)))}return t}function ee(a){const e=me(a),i=new Uint8Array(256*4);for(let t=0;t<256;t++)i[t*4]=e[t*3],i[t*4+1]=e[t*3+1],i[t*4+2]=e[t*3+2],i[t*4+3]=255;const n=new De(i,256,1,Te,te);return n.minFilter=z,n.magFilter=z,n.wrapS=R,n.wrapT=R,n.needsUpdate=!0,n}const ze=`precision highp float;
