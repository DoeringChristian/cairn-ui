import{j as i,aZ as ve,r as g,d as xe,av as ie,au as he,z as be,m as ge}from"./parse-overlay-krmoXN04.js";import{bo as Me,J as X,b5 as E,bh as T,b6 as ee,z as ye,p as we}from"./index-BL3ryy70.js";import{u as Se,o as Ce,R as De,U as se,p as L,C as F,q as B,s as je,t as Te,G as Pe,v as Ae,m as Oe,S as Ve,w as ke,x as Re,d as re,e as le,f as Ee,V as _,y as Ie,h as Fe,i as ze,j as Ne,r as Ue,O as ae,k as Le}from"./OffscreenComparePanes-Ddz7rKsN.js";import"./parse-npz-7nnkUWZQ.js";const _e={dark:856343,light:16185594},oe=256;let I=null;function Be(){if(I!==null)return I;try{const e=document.createElement("canvas").getContext("webgl2");if(e){const n=e.getExtension("WEBGL_lose_context");n==null||n.loseContext()}I=!!e}catch{I=!1}return I}function Xe(o,e,n){const t=n-e||1,a=new Uint8Array(o.length);for(let r=0;r<o.length;r++){const s=(o[r]-e)/t;a[r]=Math.max(0,Math.min(255,Math.round(s*255)))}return a}function ne(o){const e=xe(o),n=new Uint8Array(256*4);for(let a=0;a<256;a++)n[a*4]=e[a*3],n[a*4+1]=e[a*3+1],n[a*4+2]=e[a*3+2],n[a*4+3]=255;const t=new ke(n,256,1,Re,se);return t.minFilter=L,t.magFilter=L,t.wrapS=F,t.wrapT=F,t.needsUpdate=!0,t}const Ge=`precision highp float;
