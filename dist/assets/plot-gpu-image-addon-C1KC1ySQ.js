var Yn=Object.defineProperty;var Xn=(e,t,r)=>t in e?Yn(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var U=(e,t,r)=>Xn(e,typeof t!="symbol"?t+"":t,r);import{Y as Ot,Z as jn,r as d,$ as Zn,a0 as Oe,a1 as Yr,a2 as Xr,a3 as jr,a4 as Qn,a5 as Jn,a6 as ea,a7 as ta,a8 as Zr,a9 as Qr,aa as Jr,ab as ft,j as Q,V as tr,ac as ra,ad as en,ae as tn,af as rn,ag as nn,ah as an,ai as sn,aj as on,ak as cn,al as rr,am as nr,an as un,ao as ln,ap as na,aq as At,ar as ke,N as aa,as as sa,at as ia,au as oa,av as ca,aw as ua,ax as Kt,ay as la,d as fa}from"./parse-overlay-DVkN5vTG.js";import{b as da}from"./compare-mode-menu-DG9F3B3b.js";const ar=GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.COPY_SRC;function fn(e,t){const r=navigator.gpu.getPreferredCanvasFormat();return e.configure({device:t,format:r,alphaMode:"premultiplied",usage:ar}),{hdr:!1,format:r}}function pa(e,t){try{return e.configure({device:t,format:"rgba16float",colorSpace:"display-p3",toneMapping:{mode:"extended"},alphaMode:"premultiplied",usage:ar}),{hdr:!0,format:"rgba16float",colorSpace:"display-p3",toneMappingMode:"extended"}}catch{try{return e.configure({device:t,format:"rgba16float",colorSpace:"display-p3",toneMapping:{mode:"standard"},alphaMode:"premultiplied",usage:ar}),{hdr:!0,format:"rgba16float",colorSpace:"display-p3",toneMappingMode:"standard"}}catch{return fn(e,t)}}}const ma=`
...
`;class ha extends Error{constructor(r){super(r);U(this,"deviceLost",!0);this.name="DeviceLostError"}}async function vr(e,t){try{await e.mapAsync(GPUMapMode.READ)}catch(r){if((r instanceof Error?r.name:"")==="AbortError"){const a=t.info;throw new ha("webgpu readback: buffer map aborted — device lost or destroyed mid-readback"+(a?` (reason=${String(a.reason)}${a.message?`: ${a.message}`:""})`:"")+`: ${r instanceof Error?r.message:String(r)}`)}throw r instanceof Error?r:new Error(String(r))}}function sr(e){switch(e){case"rgba8unorm":return"rgba8unorm";case"rgba16float":return"rgba16float";case"rgba32float":return"rgba32float";case"r32float":return"r32float";default:{const t=e;throw new Error(`webgpu device: unknown TextureFormat ${String(t)}`)}}}function dn(e){switch(e){case"rgba8unorm":return 4;case"rgba16float":return 8;case"rgba32float":return 16;case"r32float":return 4;default:{const t=e;throw new Error(`webgpu device: unknown TextureFormat ${String(t)}`)}}}function xa(e){const t=(e&32768)>>15,r=(e&31744)>>10,n=e&1023;let a;return r===0?a=n/1024*Math.pow(2,-14):r===31?a=n?NaN:1/0:a=(1+n/1024)*Math.pow(2,r-15),t?-a:a}const ba={texture:0,sampler:1,uniform:2};function qt(e,t){return e*3+ba[t]}const va={f32:4,i32:4,u32:4,"vec2<f32>":8,vec2f:8,"vec3<f32>":12,vec3f:12,"vec4<f32>":16,vec4f:16,"mat4x4<f32>":64,mat4x4f:64};function ya(e){const t=new Map,r=/@group\(0\)\s*@binding\((\d+)\)\s*var(<uniform>)?\s+\w+\s*:\s*([^;]+);/g;let n;for(;(n=r.exec(e))!==null;){const a=Number(n[1]),s=n[2]!==void 0,i=n[3].trim();if(s){const o=va[i];if(o===void 0)throw new Error(`webgpu device: parseWGSLBindings doesn't know the size of uniform type "${i}" (binding ${a}). Add it to WGSL_UNIFORM_TYPE_SIZE.`);t.set(a,{kind:"uniform",sizeBytes:o})}else i==="sampler"||i==="sampler_comparison"?t.set(a,{kind:"sampler"}):t.set(a,{kind:"texture"})}return t}class yr{constructor(t,r,n,a){U(this,"width");U(this,"height");U(this,"format");U(this,"gpuTexture");U(this,"device");U(this,"destroyed",!1);this.device=t,this.width=r,this.height=n,this.format=a,this.gpuTexture=t.createTexture({size:{width:r,height:n,depthOrArrayLayers:1},format:sr(a),usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.COPY_SRC|GPUTextureUsage.RENDER_ATTACHMENT})}write(t){if(this.destroyed)throw new Error("webgpu device: write() on a destroyed texture");const r=this.width*dn(this.format);this.device.queue.writeTexture({texture:this.gpuTexture},t,{bytesPerRow:r,rowsPerImage:this.height},{width:this.width,height:this.height,depthOrArrayLayers:1})}destroy(){this.destroyed||(this.gpuTexture.destroy(),this.destroyed=!0)}}class wr{constructor(t){U(this,"_s");U(this,"gpuSampler");this.gpuSampler=t,this._s=t}}class wa{constructor(t,r,n,a,s){U(this,"_p");U(this,"gpuPipeline");U(this,"bindings");U(this,"bindGroupLayout");U(this,"variants");U(this,"buildVariant");this.gpuPipeline=t,this.bindings=r,this.bindGroupLayout=n,this.buildVariant=s,this.variants=new Map([[a,t]]),this._p=t}pipelineFor(t){let r=this.variants.get(t);return r||(r=this.buildVariant(t),this.variants.set(t,r)),r}}function Ea(e,t){const r=[];for(const[n,a]of t)a.kind==="uniform"?r.push({binding:n,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}):a.kind==="sampler"?r.push({binding:n,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}):r.push({binding:n,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float"}});return e.createBindGroupLayout({entries:r})}class Ra{constructor(t){U(this,"_c");U(this,"gpuPipeline");this.gpuPipeline=t,this._c=t}}class Sa{constructor(t,r,n,a,s){U(this,"width");U(this,"height");U(this,"paramsBuffer");U(this,"bindGroup");U(this,"buffers");U(this,"destroyed",!1);this.width=t,this.height=r,this.buffers=n,this.paramsBuffer=a,this.bindGroup=s}destroy(){if(!this.destroyed){for(const t of this.buffers)t.destroy();this.paramsBuffer.destroy(),this.destroyed=!0}}}class _a{constructor(t,r){U(this,"_b");U(this,"gpuBindGroup");U(this,"ownedBuffers");U(this,"destroyed",!1);this.gpuBindGroup=t,this.ownedBuffers=r,this._b=t}destroy(){if(!this.destroyed){for(const t of this.ownedBuffers)t.destroy();this.destroyed=!0}}}class Aa{constructor(t,r,n,a){U(this,"canvas");U(this,"hdr");U(this,"format");U(this,"context");U(this,"reconfigure");this.canvas=t,this.context=r,this.hdr=n.hdr,this.format=n.format,this.reconfigure=a}configure(t,r){this.canvas.width=t,this.canvas.height=r;const n=this.reconfigure();this.hdr=n.hdr,this.format=n.format}getCurrentTextureView(){return this.context.getCurrentTexture().createView()}getCurrentGPUTexture(){return this.context.getCurrentTexture()}}function St(e){return"canvas"in e}async function Ta(){if(!("gpu"in navigator)||!navigator.gpu)throw new Error("webgpu device: navigator.gpu is not available in this browser");const e=await navigator.gpu.requestAdapter();if(!e)throw new Error("webgpu device: requestAdapter() returned null");const t=await e.requestDevice(),r={hdr:!0,compute:!0,float16:!0};let n=null;function a(){return n||(n=t.createSampler({magFilter:"nearest",minFilter:"nearest",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"})),n}function s(l){return St(l)?l.getCurrentTextureView():l.gpuTexture.createView()}function i(l){if(St(l))return{width:l.canvas.width,height:l.canvas.height};const h=l;return{width:h.width,height:h.height}}let o=!1;const u={};t.lost.then(l=>{u.info=l},()=>{});let c=null;function f(){var h,w;if(c!==null)return c;let l=!1;try{if(typeof document<"u"){const y=document.createElement("canvas");y.width=1,y.height=1;const S=y.getContext("webgpu");if(S)try{S.configure({device:t,format:"rgba16float",colorSpace:"display-p3",toneMapping:{mode:"extended"},alphaMode:"premultiplied",usage:GPUTextureUsage.RENDER_ATTACHMENT});const k=(h=S.getConfiguration)==null?void 0:h.call(S);l=((w=k==null?void 0:k.toneMapping)==null?void 0:w.mode)==="extended"}catch{l=!1}finally{try{S.unconfigure()}catch{}}}}catch{l=!1}return c=l,l}const g=256;let p=null,x=null;function b(){if(!p||!x){const l=t.createShaderModule({code:ma});x=t.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"unfilterable-float"}},{binding:1,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"unfilterable-float"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]});const h=t.createPipelineLayout({bindGroupLayouts:[x]});p=t.createComputePipeline({layout:h,compute:{module:l,entryPoint:"cs_main"}})}return{pipeline:p,layout:x}}let R=null,A=null;function E(){if(!R||!A){const l=t.createShaderModule({code:ga});A=t.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]});const h=t.createPipelineLayout({bindGroupLayouts:[A]});R=t.createRenderPipeline({layout:h,vertex:{module:l,entryPoint:"vs_main"},fragment:{module:l,entryPoint:"fs_main",targets:[{format:"rgba16float"}]},primitive:{topology:"triangle-list"}})}return{pipeline:R,layout:A}}return{backend:"webgpu",capabilities:r,probeExtendedToneMapping:f,createTexture(l,h,w){return new yr(t,l,h,w)},createSampler(l){const h=(l==null?void 0:l.filter)==="linear"?"linear":"nearest",w=t.createSampler({magFilter:h,minFilter:h,addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"});return new wr(w)},createRenderPipeline(l){const h=t.createShaderModule({code:l.shaderWGSL}),w=ya(l.shaderWGSL),y=sr(l.targetFormat),S=Ea(t,w),k=t.createPipelineLayout({bindGroupLayouts:[S]}),G=L=>t.createRenderPipeline({layout:k,vertex:{module:h,entryPoint:"vs_main"},fragment:{module:h,entryPoint:"fs_main",targets:[{format:L}]},primitive:{topology:"triangle-list"}}),B=G(y);return new wa(B,w,S,y,G)},createComputePipeline(l){const h=t.createShaderModule({code:l.shaderWGSL}),w=t.createComputePipeline({layout:"auto",compute:{module:h,entryPoint:"cs_main"}});return new Ra(w)},createBindGroup(l,h){const w=l,y=new Map,S=[];for(const[G,B]of w.bindings)if(B.kind==="uniform"){const L=t.createBuffer({size:B.sizeBytes,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});S.push(L),y.set(G,{binding:G,resource:{buffer:L}})}else B.kind==="sampler"&&y.set(G,{binding:G,resource:a()});for(const G of h){const B=G.resource;if(B instanceof yr){const L=qt(G.binding,"texture");w.bindings.has(L)&&y.set(L,{binding:L,resource:B.gpuTexture.createView()})}else if(B instanceof wr){const L=qt(G.binding,"sampler");w.bindings.has(L)&&y.set(L,{binding:L,resource:B.gpuSampler})}else{const L=qt(G.binding,"uniform"),K=w.bindings.get(L);if(K&&K.kind==="uniform"){const F=B.uniform,Y=t.createBuffer({size:Math.max(K.sizeBytes,F.byteLength),usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});t.queue.writeBuffer(Y,0,F.buffer,F.byteOffset,F.byteLength),S.push(Y),y.set(L,{binding:L,resource:{buffer:Y}})}}}const k=t.createBindGroup({layout:w.bindGroupLayout,entries:Array.from(y.values())});return new _a(k,S)},createSurface(l,h){const w=l.getContext("webgpu");if(!w)throw new Error("webgpu device: canvas.getContext('webgpu') returned null");const y=h.hdr&&r.hdr,S=()=>y?pa(w,t):fn(w,t),k=S();return new Aa(l,w,k,S)},renderFullscreen(l,h,w){const y=h,S=w,k=s(l),{width:G,height:B}=i(l),L=St(l)?l.format:sr(l.format),K=y.pipelineFor(L),F=t.createCommandEncoder(),Y=F.beginRenderPass({colorAttachments:[{view:k,loadOp:"clear",clearValue:{r:0,g:0,b:0,a:0},storeOp:"store"}]});Y.setPipeline(K),Y.setBindGroup(0,S.gpuBindGroup),Y.setViewport(0,0,G,B,0,1),Y.draw(3),Y.end(),t.queue.submit([F.finish()])},createDeepSampleBuffers(l){const{layout:h}=E(),w=L=>{const K=t.createBuffer({size:L.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST});return t.queue.writeBuffer(K,0,L.buffer,L.byteOffset,L.byteLength),K},y=w(l.offsets),S=w(l.colors),k=w(l.zs),G=t.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),B=t.createBindGroup({layout:h,entries:[{binding:0,resource:{buffer:y}},{binding:1,resource:{buffer:S}},{binding:2,resource:{buffer:k}},{binding:3,resource:{buffer:G}}]});return new Sa(l.width,l.height,[y,S,k],G,B)},compositeDeep(l,h,w,y){const S=l,k=h,{pipeline:G}=E();t.queue.writeBuffer(S.paramsBuffer,0,new Float32Array([S.width,S.height,y,w]));const B=t.createCommandEncoder(),L=B.beginRenderPass({colorAttachments:[{view:k.gpuTexture.createView(),loadOp:"clear",clearValue:{r:0,g:0,b:0,a:0},storeOp:"store"}]});L.setPipeline(G),L.setBindGroup(0,S.bindGroup),L.setViewport(0,0,k.width,k.height,0,1),L.draw(3),L.end(),t.queue.submit([B.finish()])},async readback(l){const h=St(l),{width:w,height:y}=i(l),S=h?l.hdr?"rgba16float":"rgba8unorm":l.format,k=h&&l.format==="bgra8unorm",G=h?l.getCurrentGPUTexture():l.gpuTexture,B=dn(S),L=w*B,K=256,F=Math.ceil(L/K)*K,Y=F*y,te=t.createBuffer({size:Y,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ}),ue=t.createCommandEncoder();ue.copyTextureToBuffer({texture:G},{buffer:te,bytesPerRow:F,rowsPerImage:y},{width:w,height:y,depthOrArrayLayers:1}),t.queue.submit([ue.finish()]);try{await vr(te,u)}catch(H){try{te.destroy()}catch{}throw H}const j=new Uint8Array(te.getMappedRange()),J=new Uint8Array(L*y);for(let H=0;H<y;H++){const se=H*F,ee=H*L;J.set(j.subarray(se,se+L),ee)}if(te.unmap(),te.destroy(),S==="rgba8unorm"){if(k)for(let H=0;H<J.length;H+=4){const se=J[H],ee=J[H+2];J[H]=ee,J[H+2]=se}return J}if(S==="rgba16float"){const H=new Uint16Array(J.buffer,J.byteOffset,J.byteLength/2),se=new Float32Array(H.length);for(let ee=0;ee<H.length;ee++)se[ee]=xa(H[ee]);return se}return new Float32Array(J.buffer,J.byteOffset,J.byteLength/4)},async reduceDiffSumSquaredAbs(l,h,w,y){const S=l,k=h,G=Math.max(0,w*y),B=Math.max(1,Math.ceil(G/g)),{pipeline:L,layout:K}=b(),F=B*2*4,Y=t.createBuffer({size:F,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC}),te=t.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});t.queue.writeBuffer(te,0,new Uint32Array([Math.max(1,w),Math.max(1,y),G,0]));const ue=t.createBindGroup({layout:K,entries:[{binding:0,resource:S.gpuTexture.createView()},{binding:1,resource:k.gpuTexture.createView()},{binding:2,resource:{buffer:Y}},{binding:3,resource:{buffer:te}}]}),j=t.createBuffer({size:F,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ}),J=t.createCommandEncoder(),H=J.beginComputePass();H.setPipeline(L),H.setBindGroup(0,ue),H.dispatchWorkgroups(B),H.end(),J.copyBufferToBuffer(Y,0,j,0,F),t.queue.submit([J.finish()]);try{await vr(j,u)}catch(ne){for(const Ie of[j,Y,te])try{Ie.destroy()}catch{}throw ne}const ee=new Float32Array(j.getMappedRange()).slice();j.unmap(),j.destroy(),Y.destroy(),te.destroy();let oe=0,Se=0;for(let ne=0;ne<B;ne++)oe+=ee[ne*2],Se+=ee[ne*2+1];return{sumSq:oe,sumAbs:Se}},destroy(){o||(t.destroy(),o=!0)},isContextLost(){return!1}}}let Yt=null;async function Ma(){if(typeof navigator>"u"||!("gpu"in navigator)||!navigator.gpu)throw new Error("cairn-plot engine: WebGPU is not available (no navigator.gpu) — no fallback backend in the engine, caller must use the legacy CPU pane");return Ta()}function Ut(){return Yt||(Yt=Ma()),Yt}const Pa=`
struct VSOut {
...
`}const Ba=pn("select(colorB, colorA, uv.x < split)"),La=pn("mix(colorA, colorB, alpha)");function Ca(e){switch(e){case"center":return{v:"center",h:"center"};case"top-right":return{v:"top",h:"right"};case"bottom-left":return{v:"bottom",h:"left"};case"bottom-right":return{v:"bottom",h:"right"};case"top-left":default:return{v:"top",h:"left"}}}function Er(e,t,r){const{v:n,h:a}=Ca(r),s=e.w-t.w,i=e.h-t.h,o=a==="left"?0:a==="right"?s:Math.floor(s/2),u=n==="top"?0:n==="bottom"?i:Math.floor(i/2);return{x:o,y:u}}function mt(e,t,r,n,a="b"){if(n==="fill"){const i=a==="a"?{w:e.w,h:e.h}:{w:t.w,h:t.h};return{fit:n,result:i,offsetA:{x:0,y:0},offsetB:{x:0,y:0}}}const s={w:Math.min(e.w,t.w),h:Math.min(e.h,t.h)};return{fit:n,result:s,offsetA:Er(e,s,r),offsetB:Er(t,s,r)}}function ur(e){return`${e.fit}:${e.result.w}x${e.result.h}:${e.offsetA.x},${e.offsetA.y}:${e.offsetB.x},${e.offsetB.y}`}const Tt={linear:0,srgb:1,reinhard:2,aces:3,extended:4,"extended-reinhard":5,"extended-aces":6,"extended-clamp":7,gamma:8},Rr=new WeakMap;function ka(e,t){let r=Rr.get(e);r||(r=new Map,Rr.set(e,r));let n=r.get(t);return n||(n=e.createRenderPipeline({shaderWGSL:Pa,targetFormat:t}),r.set(t,n)),n}function mn(e){return"canvas"in e?e.hdr?"rgba16float":"rgba8unorm":e.format}function gn(e,t){if(t){if(t.length!==256*4)throw new Error(`renderImage: params.colormap must have exactly 256*4=1024 floats (256x4 RGBA LUT), got ${t.length}`);const n=e.createTexture(256,1,"rgba32float");return n.write(t),n}const r=e.createTexture(1,1,"rgba32float");return r.write(new Float32Array([0,0,0,1])),r}function Ga(e,t,r,n){var E;const a=mn(t),s=ka(e,a),i=gn(e,n.isScalar?n.colormap:void 0),o=typeof n.gamma=="number"&&n.gamma>0?n.gamma:0,u=Tt[n.operator]??Tt.srgb,c=new Float32Array([n.exposureEV,u,o,n.isScalar?1:0]),f=new Float32Array([n.uv.x,n.uv.y,n.uv.w,n.uv.h]),g=new Float32Array([n.hdrOut?1:0]),p=new Float32Array([n.filter==="nearest"?0:1]),x=new Float32Array([n.offset??0]),b=new Float32Array([n.peak??Ot]),R=new Float32Array([n.srgbDecode?1:0]);let A;try{A=e.createBindGroup(s,[{binding:0,resource:r},{binding:1,resource:i},{binding:2,resource:{uniform:c}},{binding:3,resource:{uniform:f}},{binding:4,resource:{uniform:g}},{binding:5,resource:{uniform:p}},{binding:6,resource:{uniform:x}},{binding:7,resource:{uniform:b}},{binding:8,resource:{uniform:R}}]),e.renderFullscreen(t,s,A)}finally{(E=A==null?void 0:A.destroy)==null||E.call(A),i.destroy()}}const Sr=new WeakMap;function Oa(e,t,r){let n=Sr.get(e);n||(n=new Map,Sr.set(e,n));const a=`${t}:${r}`;let s=n.get(a);return s||(s=e.createRenderPipeline({shaderWGSL:t==="split"?Ba:La,targetFormat:r}),n.set(a,s)),s}function Ua(e,t,r,n,a){var R;if(a.mode==="diff")throw new Error("renderCompose: mode 'diff' is handled by the diff-engine, not renderCompose");const s=mn(t),i=Oa(e,a.mode,s),o=gn(e,a.isScalar?a.colormap:void 0),u=typeof a.gamma=="number"&&a.gamma>0?a.gamma:0,c=Tt[a.operator]??Tt.srgb,f=new Float32Array([a.exposureEV,c,u,a.isScalar?1:0]),g=new Float32Array([a.uv.x,a.uv.y,a.uv.w,a.uv.h]),p=new Float32Array([a.split,a.alpha,a.hdrOut?1:0,a.filter==="nearest"?0:1]),x=new Float32Array([a.offset??0,a.peak??Ot,a.srgbDecodeA?1:0,a.srgbDecodeB?1:0]);let b;try{b=e.createBindGroup(i,[{binding:0,resource:r},{binding:1,resource:n},{binding:2,resource:o},{binding:3,resource:{uniform:f}},{binding:4,resource:{uniform:g}},{binding:5,resource:{uniform:p}},{binding:6,resource:{uniform:x}}]),e.renderFullscreen(t,i,b)}finally{(R=b==null?void 0:b.destroy)==null||R.call(b),o.destroy()}}function _r(e,t,r){if(r<=0)return{mse:0,psnr:1/0,mae:0};const n=e/r,a=t/r,s=n<=0?1/0:10*Math.log10(1/n);return{mse:n,psnr:s,mae:a}}async function hn(e,t,r,n){const a=n??mt({w:t.width,h:t.height},{w:r.width,h:r.height},"top-left","crop","b"),s=a.result.w,i=a.result.h,o=s*i*3;if(o<=0)return{mse:0,psnr:1/0,mae:0};if(a.fit==="crop"&&a.offsetA.x===0&&a.offsetA.y===0&&a.offsetB.x===0&&a.offsetB.y===0&&e.reduceDiffSumSquaredAbs){const{sumSq:l,sumAbs:h}=await e.reduceDiffSumSquaredAbs(t,r,s,i);return _r(l,h,o)}const c=await e.readback(t),f=await e.readback(r),g=c instanceof Uint8Array?255:1,p=f instanceof Uint8Array?255:1,x=Mt(c,t.width,t.height,g,a.offsetA,a.fit==="fill",s,i),b=Mt(f,r.width,r.height,p,a.offsetB,a.fit==="fill",s,i);let R=0,A=0;const E=[0,0,0],v=[0,0,0];for(let l=0;l<i;l++)for(let h=0;h<s;h++){x(h,l,E),b(h,l,v);for(let w=0;w<3;w++){const y=E[w]-v[w];R+=y*y,A+=Math.abs(y)}}return _r(R,A,o)}function Mt(e,t,r,n,a,s,i,o){const u=(g,p,x)=>e[(p*t+g)*4+x]??0;if(!s)return(g,p,x)=>{const b=Math.min(Math.max(g+a.x,0),t-1),R=Math.min(Math.max(p+a.y,0),r-1);x[0]=u(b,R,0)/n,x[1]=u(b,R,1)/n,x[2]=u(b,R,2)/n};const c=t-1,f=r-1;return(g,p,x)=>{const b=(g+.5)/i,R=(p+.5)/o,A=b*t-.5,E=R*r-.5,v=Math.floor(A),l=Math.floor(E),h=A-v,w=E-l,y=Math.min(Math.max(v,0),c),S=Math.min(Math.max(v+1,0),c),k=Math.min(Math.max(l,0),f),G=Math.min(Math.max(l+1,0),f);for(let B=0;B<3;B++){const L=u(y,k,B),K=u(S,k,B),F=u(y,G,B),Y=u(S,G,B),te=L+(K-L)*h,ue=F+(Y-F)*h;x[B]=(te+(ue-te)*w)/n}}}function xn(){if(typeof location>"u")return!1;try{return new URLSearchParams(location.search).has("forceEngineFail")}catch{return!1}}const Fa=12,Fe=[];function Ar(e){const t=Fe.indexOf(e);t!==-1&&Fe.splice(t,1),Fe.push(e)}function Ia(e){const t=Fe.indexOf(e);t!==-1&&Fe.splice(t,1)}function Pt(e){e.parked||(Ia(e),e.srcTexture&&(e.srcTexture.destroy(),e.srcTexture=null),e.deepBuffers&&(e.deepBuffers.destroy(),e.deepBuffers=null),e.surface=null,e.parked=!0)}function Tr(e){for(;Fe.length>Fa;){const t=Fe.find(r=>r!==e&&!r.visible)??Fe.find(r=>r!==e);if(!t)break;Pt(t)}}function bn(e){var a,s,i,o;if(e.disposed)return;if(xn())throw new Error("cairn-plot engine: forced pane activation failure (?forceEngineFail test hook)");if(!e.parked&&e.surface){Ar(e),Tr(e);return}const t=e.device;e.surface=t.createSurface(e.canvas,{hdr:e.hdr});const r=e.backingWidth||((a=e.source)==null?void 0:a.width)||((s=e.deep)==null?void 0:s.width)||1,n=e.backingHeight||((i=e.source)==null?void 0:i.height)||((o=e.deep)==null?void 0:o.height)||1;if(e.canvas.width=r,e.canvas.height=n,e.surface.configure(r,n),e.deep){const u=t.createTexture(e.deep.width,e.deep.height,"rgba16float");e.srcTexture=u,e.deepBuffers=t.createDeepSampleBuffers(e.deep),t.compositeDeep(e.deepBuffers,u,e.deepZNear,e.deepZFar)}else if(e.source){const u=t.createTexture(e.source.width,e.source.height,e.source.format);u.write(e.source.data),e.srcTexture=u}e.parked=!1,Ar(e),Tr(e)}function Na(e,t){if(e.disposed||!e.source&&!e.deep)return!0;try{return bn(e),!e.surface||!e.srcTexture?!1:(Ga(e.device,e.surface,e.srcTexture,t),!0)}catch(r){return console.warn("cairn-plot engine: pane activation/render failed, falling back to legacy pane",r),e.parked=!1,Pt(e),!1}}function za(e){return{canvas:e.canvas,get isParked(){return e.parked},setSource(t){if(!e.disposed&&(e.source=t,e.deep=null,e.deepBuffers&&(e.deepBuffers.destroy(),e.deepBuffers=null),!e.parked&&e.surface)){e.srcTexture&&e.srcTexture.destroy();const r=e.device.createTexture(t.width,t.height,t.format);r.write(t.data),e.srcTexture=r}},setDeepSource(t,r,n){if(!e.disposed&&(e.deep=t,e.deepZNear=r,e.deepZFar=n,e.source=null,!e.parked&&e.surface)){e.srcTexture&&e.srcTexture.destroy(),e.deepBuffers&&e.deepBuffers.destroy();const a=e.device.createTexture(t.width,t.height,"rgba16float");e.srcTexture=a,e.deepBuffers=e.device.createDeepSampleBuffers(t),e.device.compositeDeep(e.deepBuffers,a,r,n)}},setDeepWindow(t,r){e.disposed||(e.deepZNear=t,e.deepZFar=r,!e.parked&&e.deepBuffers&&e.srcTexture&&e.device.compositeDeep(e.deepBuffers,e.srcTexture,t,r))},resize(t,r){if(e.disposed)return;const n=Math.max(1,Math.round(t)),a=Math.max(1,Math.round(r));e.backingWidth===n&&e.backingHeight===a||(e.backingWidth=n,e.backingHeight=a,!e.parked&&e.surface&&(e.canvas.width=n,e.canvas.height=a,e.surface.configure(n,a)))},render(t){return Na(e,t)},park(){e.disposed||Pt(e)},restore(){e.disposed||!e.source&&!e.deep||bn(e)},setVisible(t){e.disposed||(e.visible=t)},dispose(){e.disposed||(Pt(e),e.source=null,e.deep=null,e.disposed=!0)}}}async function Va(e,t){const r=await Ut(),n={canvas:e,device:r,hdr:(t==null?void 0:t.hdr)??!1,surface:null,srcTexture:null,source:null,deep:null,deepZNear:-1/0,deepZFar:1/0,deepBuffers:null,parked:!0,disposed:!1,visible:!0,backingWidth:0,backingHeight:0};return za(n)}function Mr(e){e.dispose()}const Pr={"no-webgpu":0,"no-hdr-browser":1,"no-hdr-display":2},$a="https://github.com/doeringchristian/cairn-plot/blob/main/docs/browser-support.md";function Ha(e,t=!1){const r=e||"";return t?"brave":/firefox/i.test(r)?"firefox":/safari/i.test(r)&&!/chrome|chromium|crios|android/i.test(r)?"safari":/linux/i.test(r)&&/chrome|chromium/i.test(r)?"chromium-linux":"chromium"}function Wa(e){const t=e||"";return/mac os x|macintosh/i.test(t)?"macos":/windows/i.test(t)?"windows":"other"}function Ka(e,t){if(e==="no-hdr-display")switch(Wa(t.userAgent)){case"macos":return"macOS: EDR engages automatically on HDR-capable displays — confirm your display supports HDR.";case"windows":return"Windows: turn on Settings → System → Display → Use HDR.";default:return"Enable HDR in your display and OS settings."}const r=Ha(t.userAgent,t.isBrave);if(e==="no-hdr-browser")switch(r){case"firefox":return"Firefox has no extended-tone-mapping canvas path at all — true HDR output is impossible until Firefox implements it (fundamental browser limitation).";case"safari":return"Safari's WebGPU HDR canvas tone-mapping is still maturing — update to the latest Safari 26+.";default:return"Chrome/Edge 129+ is required for HDR canvas output (toneMapping: extended) — update your browser."}switch(r){case"firefox":return"Firefox: about:config → dom.webgpu.enabled (HDR output is not available in Firefox at all — browser limitation).";case"safari":return"Safari: Develop → Feature Flags → WebGPU (Safari 26+ has it by default).";case"brave":return"Brave: check Shields fingerprint blocking + brave://flags.";case"chromium-linux":return"Chromium on Linux: enable chrome://flags/#enable-unsafe-webgpu.";case"chromium":default:return"Chrome/Edge: enable chrome://flags/#enable-unsafe-webgpu and hardware acceleration."}}function qa(e){switch(e){case"no-webgpu":return"GPU renderer unavailable → CPU fallback active; FLIP kernels + HDR compare disabled.";case"no-hdr-browser":return"True HDR output is unsupported by this browser — a fundamental browser limitation, not a cairn-plot bug → HDR images tone-mapped to SDR.";case"no-hdr-display":return"Your display/OS is not in HDR mode → HDR images tone-mapped to SDR."}}function vn(e,t){return`cairn-plot:capnotice:${e}:${t}`}const yn=new Set;function Dr(e){try{if(window.localStorage.getItem(e)==="1")return!0}catch{}try{if(window.sessionStorage.getItem(e)==="1")return!0}catch{}return yn.has(e)}function Ya(e){try{window.localStorage.setItem(e,"1");return}catch{}try{window.sessionStorage.setItem(e,"1");return}catch{}yn.add(e)}const Br=new Set;let Dt=null,rt=null;function wn(){rt&&rt.parentNode&&rt.parentNode.removeChild(rt),rt=null,Dt=null}function Xa(e){const t=vn(e,window.location.pathname),r=Ka(e,{userAgent:navigator.userAgent,isBrave:!!navigator.brave}),n=document.createElement("div");n.setAttribute("role","status"),n.setAttribute("data-cairn-plot-capnotice",e),Object.assign(n.style,{position:"fixed",bottom:"12px",right:"12px",zIndex:"2147483000",maxWidth:"340px",boxSizing:"border-box",padding:"10px 30px 10px 12px",borderRadius:"6px",border:"1px solid var(--color-border, #d0d7de)",background:"rgb(var(--color-bg-elevated-rgb, 246 248 250) / 0.9)",color:"var(--color-fg-muted, #656d76)",backdropFilter:"blur(4px)",WebkitBackdropFilter:"blur(4px)",boxShadow:"0 4px 12px rgba(0, 0, 0, 0.18)",font:"12px/1.4 system-ui, sans-serif"});const a=document.createElement("div");a.textContent=qa(e),Object.assign(a.style,{fontWeight:"600",color:"var(--color-fg, #1f2328)",marginBottom:"4px"});const s=document.createElement("div");s.textContent=r,s.style.marginBottom="4px";const i=document.createElement("a");i.href=$a,i.target="_blank",i.rel="noopener noreferrer",i.textContent="Learn more",Object.assign(i.style,{color:"var(--color-accent, #0969da)",textDecoration:"none"});const o=document.createElement("button");o.type="button",o.textContent="×",o.setAttribute("aria-label","Dismiss browser capability notice"),o.title="Dismiss",Object.assign(o.style,{position:"absolute",top:"4px",right:"6px",padding:"0 4px",border:"0",background:"transparent",color:"var(--color-fg-subtle, #8b949e)",cursor:"pointer",fontSize:"16px",lineHeight:"1"}),o.addEventListener("click",()=>{Ya(t),wn()}),n.appendChild(a),n.appendChild(s),n.appendChild(i),n.appendChild(o),document.body.appendChild(n),rt=n,Dt=e}function En(e){if(typeof document>"u"||typeof window>"u"||Br.has(e))return;Br.add(e);const t=vn(e,window.location.pathname);if(Dr(t))return;const r=()=>{if(!Dr(t)){if(Dt!==null)if(Pr[e]<Pr[Dt])wn();else return;Xa(e)}};document.body?r():window.addEventListener("DOMContentLoaded",r,{once:!0})}const ja={data:new Float32Array(0),shape:[0,0],dtype:"<f4"};function Za(e){const{h:t,w:r,c:n}=na(e.shape);if(e.precision==="f16-bits"){const i=e.data,o=new Uint16Array(r*t*4);for(let u=0;u<r*t;u++){const c=u*n,f=u*4;if(n===1){const g=i[c];o[f]=g,o[f+1]=g,o[f+2]=g,o[f+3]=At}else o[f]=i[c],o[f+1]=i[c+1],o[f+2]=i[c+2],o[f+3]=n>=4?i[c+3]:At}return{data:o,width:r,height:t,format:"rgba16float"}}const a=e.data,s=new Float32Array(r*t*4);for(let i=0;i<r*t;i++){const o=i*n;let u,c,f,g=1;n===1?u=c=f=ke(a[o]):n===3?(u=ke(a[o]),c=ke(a[o+1]),f=ke(a[o+2])):(u=ke(a[o]),c=ke(a[o+1]),f=ke(a[o+2]),g=ke(a[o+3]));const p=i*4;s[p]=u,s[p+1]=c,s[p+2]=f,s[p+3]=g}return{data:s,width:r,height:t,format:"rgba32float"}}function Rn(e,t,r,n){if(r<=0||n<=0||t.width<=0||t.height<=0)return{x:0,y:0,w:1,h:1};const a=Math.min(t.width/r,t.height/n),s=r*a,i=n*a,o=(t.width-s)/2,u=(t.height-i)/2,c=Math.max(e.zoom,1e-6),f=t.width/(c*s),g=t.height/(c*i),p=-o/s-e.pan.x/(c*s),x=-u/i-e.pan.y/(c*i);return{x:p,y:x,w:f,h:g}}function Sn(e,t,r,n){const a=e.w*r,s=e.h*n;return a<=0||s<=0||t.width<=0||t.height<=0?0:Math.min(t.width/a,t.height/s)}function Qa(e){var ct,Qe,Je;const t=jn(e),r=d.useRef(null),n=d.useRef(null),a=d.useRef(null),s=d.useRef(null),i=d.useRef(null),o=t&&!!((ct=e.hdr)!=null&&ct.deep),u=d.useCallback((T,C)=>{var V,D;(V=s.current)==null||V.setDeepWindow(T,C),(D=i.current)==null||D.call(i)},[]),c=Zn(t?e.hdr:ja,o?u:void 0),f=d.useRef(!1),[g,p]=d.useState(!1),[x,b]=d.useState(!1),[R,A]=d.useState(!1),[E,v]=d.useState(null),[l,h]=d.useState(0),[w,y]=d.useState(0),[S,k]=d.useState({x:0,y:0,w:1,h:1}),G=d.useRef(null),B=d.useRef(null),[L,K]=d.useState(0),F=e.zoom??1,Y=e.pan??{x:0,y:0},te=e.onViewportChange,ue=e.toolbar??!0,j=t?"none":e.colormap??"none",[J,H,se]=Oe(j);d.useEffect(()=>{H(j)},[j,H]);const ee=t?"none":J,oe=e.tonemap,[Se,ne]=d.useState(null);d.useEffect(()=>{ne(null)},[oe]);const Ie=un(oe),_e=Se??Ie,It=Se!==null&&Se!==Ie,Ye=d.useCallback(()=>ne(null),[]),Xe=e.peak,gt=()=>Xe!=null&&Xe>0?Xe:ln(oe)??Ot,[nt,Pe,at]=Oe(gt());d.useEffect(()=>{Pe(gt())},[Xe,oe]);const le=e.gamma,[De,Ne,ht]=Oe(le&&le>0?le:Yr);d.useEffect(()=>{le&&le>0&&Ne(le)},[le,Ne]);const[Be,ve]=d.useState(0),[he,st]=d.useState(0),ye=Xr();d.useEffect(()=>{const T=r.current;if(!T)return;let C=!1;return Ut().then(V=>{var ie;if(C)return;const D=((ie=V.probeExtendedToneMapping)==null?void 0:ie.call(V))??!1,I=typeof matchMedia<"u"&&matchMedia("(dynamic-range: high)").matches,re=D&&I&&(t||j==="none");f.current=re,p(re),t&&!re&&En(D?"no-hdr-display":"no-hdr-browser"),Va(T,{hdr:re}).then(de=>{if(C){Mr(de);return}s.current=de,A(!0)}).catch(de=>{C||(console.warn("cairn-plot: GpuImagePane failed to acquire a pool handle, falling back to legacy pane",de),b(!0))})}).catch(V=>{C||(console.warn("cairn-plot: GpuImagePane could not resolve a GPU device, falling back to legacy pane",V),b(!0))}),()=>{C=!0,s.current&&(Mr(s.current),s.current=null)}},[]),d.useEffect(()=>{const T=n.current;if(!T)return;const C=new ResizeObserver(()=>y(V=>V+1));return C.observe(T),()=>C.disconnect()},[]),d.useEffect(()=>{const T=n.current;if(!T)return;const C=new IntersectionObserver(V=>{const D=V[0];if(!D)return;const I=s.current;I&&(I.setVisible(D.isIntersecting),D.isIntersecting?I.isParked&&(I.restore(),y(z=>z+1)):I.park())},{threshold:0});return C.observe(T),()=>C.disconnect()},[]),d.useEffect(()=>{var V;if(!t||!R||o)return;const T=c.hdr;G.current=T;const C=Za(T);(V=s.current)==null||V.setSource(C),v(D=>D&&D.w===C.width&&D.h===C.height?D:{w:C.width,h:C.height}),K(D=>D+1),h(D=>D+1)},[t,R,o,t?c.hdr:null]),d.useEffect(()=>{if(!t||!R||!o)return;const T=e.hdr,C=T.deep;G.current=T;let V=!1;return C.getGpuCsr().then(D=>{var I;V||((I=s.current)==null||I.setDeepSource(D,C.zMin,C.zMax),v(z=>z&&z.w===D.width&&z.h===D.height?z:{w:D.width,h:D.height}),K(z=>z+1),h(z=>z+1))}).catch(D=>{V||console.warn("[cairn] deep GPU CSR upload failed:",D)}),()=>{V=!0}},[t,R,o,t?e.hdr.deep:null]),d.useEffect(()=>{if(t||!R)return;const T=e,C=T.imageUrl,V=J;if(!C){B.current=null,v(null),K(I=>I+1);return}let D=!1;return jr(C).then(I=>{var ie,de;if(D||!I)return;let z=I;if(V!=="none"){const W=`gpu::${C}::${V}::ev${Be}::off${he}`,we=Qn(W);if(we)z=we;else{const $e=Jn(V);z=ea(I,V,$e,Be,he),ta(W,z)}}B.current=I;const re={data:z.data,width:z.width,height:z.height,format:"rgba8unorm"};(ie=s.current)==null||ie.setSource(re),v(W=>W&&W.w===z.width&&W.h===z.height?W:{w:z.width,h:z.height}),(de=T.onNaturalSize)==null||de.call(T,z.width,z.height),K(W=>W+1),h(W=>W+1)}),()=>{D=!0}},[t,R,t?null:e.imageUrl,t?null:J,t?0:Be,t?0:he]);const X=e.exposure??0,ze=e.offset??0,Ae=!t&&ee==="none",xe=d.useCallback(()=>{const T=s.current;if(!T||!R||!E)return;const C=n.current,V=a.current,D=V?V.getBoundingClientRect():C?C.getBoundingClientRect():{width:E.w,height:E.h},I=Rn({zoom:F,pan:Y},D,E.w,E.h);k(W=>W.x===I.x&&W.y===I.y&&W.w===I.w&&W.h===I.h?W:I),D.width>0&&D.height>0&&T.resize(Math.round(D.width*ye),Math.round(D.height*ye));const z=Sn(I,D,E.w,E.h)>=Zr?"nearest":"linear",re=I,ie=Qr(_e,f.current?nt:1,f.current,De),de=t||Ae?{exposureEV:X+Be,offset:ze+he,operator:ie.operator,gamma:ie.gamma,isScalar:!1,hdrOut:ie.hdrOut,peak:ie.peak,srgbDecode:!t,uv:re,filter:z}:{exposureEV:0,offset:0,operator:"linear",gamma:1,isScalar:!1,hdrOut:!1,srgbDecode:!1,uv:re,filter:z};try{T.render(de)||b(!0)}catch(W){console.warn("cairn-plot: GpuImagePane render failed, falling back to legacy pane",W),b(!0)}},[R,E,F,Y.x,Y.y,X,ze,Be,he,_e,nt,De,Ae,t,ee,ye]);i.current=xe,d.useEffect(()=>{xe()},[xe,l,w]);const be=d.useCallback((T,C,V)=>{if(t){const W=G.current,we=E;if(!W||!we||T<0||C<0||T>=we.w||C>=we.h)return null;const $e=W.shape.length===2?1:W.shape[2]??1,He=(C*we.w+T)*$e,et=W.data,We=W.precision==="f16-bits"?Te=>Jr(et[Te]??0):Te=>et[Te]??0,Ke=$e===1?[We(He)]:[We(He),We(He+1),We(He+2)];return ft(Ke,"unit",V)}const D=B.current;if(!D||T<0||C<0||T>=D.width||C>=D.height)return null;const I=(C*D.width+T)*4,z=D.data[I],re=D.data[I+1],ie=D.data[I+2];return ft(ee!=="none"||z===re&&re===ie?[z]:[z,re,ie],"uint8",V)},[t,E,ee]),Le=e.showAxes??!1,je=t?e.label??"":e.label,Ze=e.interpolation??"auto",it=Ze==="auto"?void 0:Ze,Ve=t?void 0:e.overlay,fe=t?void 0:e.overlaySettings,Nt=t?!1:e.isDraggable??!1,xt=t?void 0:e.onDragStart;if(x)return t?Q.jsx(tr,{...e}):Q.jsx(tr,{...e});const ot=Ve&&(fe!=null&&fe.enabled)&&E&&((((Qe=Ve.boxes)==null?void 0:Qe.length)??0)>0||(((Je=Ve.masks)==null?void 0:Je.length)??0)>0)?Q.jsx(ra,{data:Ve,settings:fe,naturalWidth:E.w,naturalHeight:E.h}):void 0;return Q.jsx(en,{paneAttrs:{"data-gpu-image-pane":"","data-gpu-backend-ready":R},viewportAttrs:{"data-gpu-image-viewport":""},toolbar:ue,paneRef:n,wrapperRef:a,zoom:F,pan:Y,onViewportChange:te,naturalDims:E,checkerboard:"wrapper",wrapperClassName:"relative w-full h-full flex items-center justify-center",viewportPadding:Le&&E?"16px 4px 4px 28px":0,surface:Q.jsx("canvas",{ref:r,className:"w-full h-full block",style:{imageRendering:it},"data-gpu-image-canvas":!0}),showAxes:Le,overlayNode:ot,overlay:{displayElRef:r,sample:be,version:L,hasSource:!0,sourceWindow:S},notationSeed:e.pixelValueNotation??"decimal",exportCanvasRef:r,requestRender:xe,leadingMenus:t?[rr(_e,T=>ne(T))]:Ae?[nr(ee,T=>H(T)),rr(_e,T=>ne(T))]:[nr(ee,T=>H(T))],displayAdjust:{exposureEV:Be,offset:he,onExposureChange:ve,onOffsetChange:st},extraSliders:[...(t||Ae)&&g?[{id:"peak",label:"PK",title:"Peak white (×SDR white) — the HDR ceiling P every operator clips at (Linear/sRGB/Gamma hard-clip at P; Reinhard/ACES roll off toward P). P=1 reproduces the SDR rendition exactly; double-click to type a value, including 'inf' for the raw browser-clipped extended look.",min:nn,max:rn,step:tn,value:nt,onChange:Pe,format:T=>Number.isFinite(T)?`${T.toFixed(1)}×`:"∞"}]:[],...(t||Ae)&&cn(_e)?[{id:"gamma",label:"γ",title:"Display gamma γ for the Gamma transfer — display = clamp(value)^(1/γ), tev-style. Default 2.2 (close to sRGB, not identical). Double-click to type a value.",min:on,max:sn,step:an,value:De,onChange:Ne,format:T=>T.toFixed(1)}]:[]],depthSliders:c.sliders,regionSelect:o?{rect:c.region,queryLive:c.queryRegionWindow,commit:c.commitRegion,remove:c.removeRegion}:void 0,onReset:()=>{se.reset(),Ye(),at.reset(),ht.reset(),c.reset()},extraModified:se.isModified||It||at.isModified||ht.isModified||c.isModified,label:je,showLabelChip:!!je,isDraggable:Nt,onDragStart:xt})}const Bt=new Map;function Ee(e){if(Bt.has(e.id))throw new Error(`registerDiffKernel: duplicate kernel id "${e.id}"`);Bt.set(e.id,e)}function Ue(e){return Bt.get(e)}function Ja(){return Array.from(Bt.values())}function _n(e,t){return{...e.params??{},...t??{}}}const es={kind:"pointwise",id:"signed",label:"Signed Error",publicName:"signed",displayRange:"signed",output:"per-channel",source:`
...
`},An=[[10135552/24577794,8788810/24577794,4435075/24577794],[2613072/12288897,8788810/12288897,887015/12288897],[1425312/73733382,8788810/73733382,70074185/73733382]];os(An);const Xt=[1.052156925,1,.91835767],is=.7;function os(e){const[t,r,n]=e[0],[a,s,i]=e[1],[o,u,c]=e[2],f=s*c-i*u,g=-(a*c-i*o),p=a*u-s*o,b=1/(t*f+r*g+n*p);return[[f*b,-(r*c-n*u)*b,(r*i-n*s)*b],[g*b,(t*c-n*o)*b,-(t*i-n*a)*b],[p*b,-(t*u-r*o)*b,(t*s-r*a)*b]]}function cs(e,t,r,n){return[e[0][0]*t+e[0][1]*r+e[0][2]*n,e[1][0]*t+e[1][1]*r+e[1][2]*n,e[2][0]*t+e[2][1]*r+e[2][2]*n]}const jt=6/29;function Zt(e){return e>jt**3?Math.cbrt(e):e/(3*jt*jt)+4/29}function Lr(e,t,r){const[n,a,s]=cs(An,e,t,r),i=Zt(n*Xt[0]),o=Zt(a*Xt[1]),u=Zt(s*Xt[2]),c=116*o-16,f=500*(i-o),g=200*(o-u);return[c,.01*c*f,.01*c*g]}function us(e,t){const r=e[0]-t[0],n=e[1]-t[1],a=e[2]-t[2];return Math.abs(r)+Math.sqrt(n*n+a*a)}function ls(){const e=Lr(0,1,0),t=Lr(0,0,1);return Math.pow(us(e,t),is)}const fs=ls(),Tn=fs,ds=.082;function Mn(e){const t=[1,1,34.1],r=[.0047,.0053,.04],n=[0,0,13.5],a=[1e-5,1e-5,.025],s=Math.max(...r,...a),i=Math.ceil(3*Math.sqrt(s/(2*Math.PI**2))*e),o=1/e,u=Math.PI**2,c=[0,0,0];for(let f=-i;f<=i;f++)for(let g=-i;g<=i;g++){const p=(g*o)**2+(f*o)**2;for(let x=0;x<3;x++)c[x]+=t[x]*Math.sqrt(Math.PI/r[x])*Math.exp(-u*p/r[x])+n[x]*Math.sqrt(Math.PI/a[x])*Math.exp(-u*p/a[x])}return{r:i,deltaX:o,sums:c}}function Pn(e){const t=.5*ds*e,r=Math.ceil(3*t);let n=0,a=0,s=0;for(let i=-r;i<=r;i++)for(let o=-r;o<=r;o++){const u=Math.exp(-(o*o+i*i)/(2*t*t)),c=-o*u,f=(o*o/(t*t)-1)*u;c>0&&(n+=c),f>0?a+=f:s-=f}return{r,sd:t,edgeNorm:n,pointPos:a,pointNeg:s}}const ps=`
${ge}
${Ft}
${qe}
${pt}
...
`;function Re(e,t){return{binding:e,resource:{uniform:new Float32Array(t)}}}function Ct(e,t,r){const n=r.sourceMap,a=n?t==="a"?n.offsetA:n.offsetB:{x:0,y:0},s=n!=null&&n.fill?1:0;return[Re(e,[a.x,a.y,s,0]),Re(e+1,[r.width,r.height,0,0])]}function kt(e){return[Re(1,[e.deltaX,e.r,e.sums[0],e.sums[1]]),Re(2,[e.sums[2],0,0,0])]}function Bn(e){return[Re(4,[Tn,e.sd,e.r,e.edgeNorm]),Re(5,[e.pointPos,e.pointNeg,0,0])]}function Ln(e,t,r,n,a,s=""){const i=Mn(e),o=Pn(e),u=`ycxczA${s}`,c=`ycxczB${s}`,f=`labA${s}`,g=`labB${s}`,p=`flip${s}`;return{passes:[{name:u,shader:t,inputs:[r],output:u,uniforms:()=>Ct(1,"a",a)},{name:c,shader:t,inputs:[n],output:c,uniforms:()=>Ct(1,"b",a)},{name:f,shader:Lt,inputs:[u],output:f,uniforms:()=>kt(i)},{name:g,shader:Lt,inputs:[c],output:g,uniforms:()=>kt(i)},{name:p,shader:Dn,inputs:[f,g,u,c],output:p,uniforms:()=>Bn(o)}],flipRef:p}}const gs={kind:"multipass",id:"flip",label:"FLIP (perceptual)",publicName:"flip",displayRange:"unit",output:"scalar",params:{ppd:67},buildPasses(e){const t=e.params.ppd??67,{passes:r,flipRef:n}=Ln(t,ps,"srcA","srcB",e);return{passes:r,final:n}}},hs={kind:"multipass",id:"flip-ldr-forced",label:"FLIP (LDR forced)",publicName:"flip_ldr",displayRange:"unit",output:"scalar",params:{ppd:67},buildPasses(e){const t=e.params.ppd??67,{passes:r,flipRef:n}=Ln(t,ms,"srcA","srcB",e);return{passes:r,final:n}}},Cr=`
${ge}
${Ft}
${qe}
${pt}
...
`,bs={kind:"multipass",id:"hdr-flip",label:"FLIP (perceptual)",publicName:"flip_hdr",displayRange:"unit",output:"scalar",params:{ppd:67,startExposure:0,stopExposure:4,numExposures:2},buildPasses(e){const t=e.params.ppd??67,r=e.params.startExposure??0,n=e.params.stopExposure??4,a=Math.max(2,Math.round(e.params.numExposures??2)),s=(n-r)/Math.max(a-1,1),i=Mn(t),o=Pn(t),u=[];let c=null;for(let f=0;f<a;f++){const g=r+f*s,p=`_e${f}`,x=`ycxczA${p}`,b=`ycxczB${p}`,R=`labA${p}`,A=`labB${p}`,E=`acc${p}`;u.push({name:x,shader:Cr,inputs:["srcA"],output:x,uniforms:()=>[Re(1,[g,0,0,0]),...Ct(2,"a",e)]},{name:b,shader:Cr,inputs:["srcB"],output:b,uniforms:()=>[Re(1,[g,0,0,0]),...Ct(2,"b",e)]},{name:R,shader:Lt,inputs:[x],output:R,uniforms:()=>kt(i)},{name:A,shader:Lt,inputs:[b],output:A,uniforms:()=>kt(i)}),c===null?u.push({name:E,shader:Dn,inputs:[R,A,x,b],output:E,uniforms:()=>Bn(o)}):u.push({name:E,shader:xs,inputs:[R,A,x,b,c],output:E,uniforms:()=>[Re(5,[Tn,o.sd,o.r,o.edgeNorm]),Re(6,[o.pointPos,o.pointNeg,0,0])]}),c=E}return{passes:u,final:c}}},Cn=.01,kn=.03,Gt=1,ir=1.5,Ge=5,Qt=[.2126,.7152,.0722];function Jt(e){return e<=.04045?e/12.92:Math.pow((e+.055)/1.055,2.4)}function kr(e,t,r){const n=Qt[0]*Jt(e)+Qt[1]*Jt(t)+Qt[2]*Jt(r);return Math.min(1,Math.max(0,n))}function vs(e,t){const r=2*t+1,n=new Float64Array(r);let a=0;for(let s=-t,i=0;s<=t;s++,i++){const o=Math.exp(-.5*s*s/(e*e));n[i]=o,a+=o}for(let s=0;s<r;s++)n[s]=n[s]/a;return n}function Gr(e,t){if(t===1)return 0;const r=2*t;let n=(e%r+r)%r;return n>=t&&(n=r-1-n),n}const Gn=()=>new Promise(e=>{typeof setTimeout=="function"?setTimeout(e,0):Promise.resolve().then(e)}),or=64;async function lt(e,t,r,n,a,s){const i=new Float64Array(t*r);for(let u=0;u<r;u++){for(let c=0;c<t;c++){let f=0;for(let g=-a,p=0;g<=a;g++,p++)f+=n[p]*e[u*t+Gr(c+g,t)];i[u*t+c]=f}(u+1)%or===0&&await s()}const o=new Float64Array(t*r);for(let u=0;u<r;u++){for(let c=0;c<t;c++){let f=0;for(let g=-a,p=0;g<=a;g++,p++)f+=n[p]*i[Gr(u+g,r)*t+c];o[u*t+c]=f}(u+1)%or===0&&await s()}return o}async function ys(e,t,r,n,a=Gn){const s=r*n;if(s<=0)return NaN;const i=vs(ir,Ge),o=new Float64Array(s),u=new Float64Array(s),c=new Float64Array(s);for(let v=0;v<s;v++)o[v]=e[v]*e[v],u[v]=t[v]*t[v],c[v]=e[v]*t[v];const f=await lt(e,r,n,i,Ge,a),g=await lt(t,r,n,i,Ge,a),p=await lt(o,r,n,i,Ge,a),x=await lt(u,r,n,i,Ge,a),b=await lt(c,r,n,i,Ge,a),R=(Cn*Gt)**2,A=(kn*Gt)**2;let E=0;for(let v=0;v<s;v++){const l=p[v]-f[v]*f[v],h=x[v]-g[v]*g[v],w=b[v]-f[v]*g[v],y=2*f[v]*g[v]+R,S=2*w+A,k=f[v]*f[v]+g[v]*g[v]+R,G=l+h+A;E+=y*S/(k*G)}return E/s}const ws=`
...
`}const _t="rgba16float";let Fn=0;function ks(){return Fn}function Gs(e,t,r,n,a,s){var A,E;const i=Ue(n);if(!i)throw new Error(`computeDiff: unknown diff kernel "${n}"`);const o=s??mt({w:t.width,h:t.height},{w:r.width,h:r.height},"top-left","crop","b"),u=o.result.w,c=o.result.h,f=o.fit==="fill"?1:0,g=_n(i,a);if(Fn++,i.kind==="pointwise"){const v=e.createTexture(u,c,_t),l=cr(e,`pw:${i.id}`,Cs(i.source),_t),h=new Float32Array([o.offsetA.x,o.offsetA.y,o.offsetB.x,o.offsetB.y]),w=new Float32Array([u,c,f,0]);let y;try{y=e.createBindGroup(l,[{binding:0,resource:t},{binding:1,resource:r},{binding:2,resource:{uniform:h}},{binding:3,resource:{uniform:w}}]),e.renderFullscreen(v,l,y)}finally{(A=y==null?void 0:y.destroy)==null||A.call(y)}return v}const p={width:u,height:c,params:g,sourceMap:{fill:o.fit==="fill",offsetA:o.offsetA,offsetB:o.offsetB}},x=i.buildPasses(p),b=new Map([["srcA",t],["srcB",r]]),R=[];try{for(const l of x.passes){const h=e.createTexture(u,c,_t);R.push(h),b.set(l.output,h);const w=cr(e,`mp:${i.id}:${l.name}`,l.shader,_t),y=l.inputs.map((k,G)=>{const B=b.get(k);if(!B)throw new Error(`computeDiff: pass "${l.name}" input "${k}" not produced yet`);return{binding:G,resource:B}});l.uniforms&&y.push(...l.uniforms(p));let S;try{S=e.createBindGroup(w,y),e.renderFullscreen(h,w,S)}finally{(E=S==null?void 0:S.destroy)==null||E.call(S)}}const v=b.get(x.final);if(!v)throw new Error(`computeDiff: final ref "${x.final}" not produced`);for(const l of R)l!==v&&l.destroy();return v}catch(v){for(const l of R)l.destroy();throw v}}function Os(e,t){const r=_n(e,t);return Object.keys(r).sort().map(a=>`${a}=${r[a]}`).join(",")}function Us(e,t,r,n,a){const s=Ue(r),i=s?Os(s,n):"",o=a?ur(a):"";return`${e}|${t}|${r}|${i}|${o}`}function In(e,t,r,n,a,s,i,o){const u=Ue(n);if(!u)throw new Error(`ensureDiff: unknown diff kernel "${n}"`);const c=lr(e),f=o??mt({w:t.width,h:t.height},{w:r.width,h:r.height},"top-left","crop","b"),g=Us(s,i,n,a,f),p=c.get(g);if(p)return p;const x=Gs(e,t,r,n,a,f),b=f.result.w,R=f.result.h,A={texture:x,width:b,height:R,displayRange:u.displayRange,bytes:b*R*8};return c.set(g,A),A}function Fs(e,t,r){return`${e}|${t}|${r?ur(r):""}`}function Is(e,t,r,n,a,s){return Ls(e,Fs(n,a,s),()=>Ns(e,t,r,n,a,s))}async function Ns(e,t,r,n,a,s){try{const i=In(e,t,r,"ssim",void 0,n,a,s);return i.ssimMean!==void 0?i.ssimMean:(i.ssimMeanPending||(i.ssimMeanPending=Nn(e,i).then(o=>{const u=Bs(o,i.width,i.height);return i.ssimMean=u,u})),await i.ssimMeanPending)}catch{return zs(e,t,r,s)}}async function zs(e,t,r,n){const a=n??mt({w:t.width,h:t.height},{w:r.width,h:r.height},"top-left","crop","b"),s=a.result.w,i=a.result.h,o=s*i;if(o<=0)return NaN;const u=await e.readback(t),c=await e.readback(r),f=u instanceof Uint8Array?255:1,g=c instanceof Uint8Array?255:1,p=a.fit==="fill",x=Mt(u,t.width,t.height,f,a.offsetA,p,s,i),b=Mt(c,r.width,r.height,g,a.offsetB,p,s,i),R=new Float64Array(o),A=new Float64Array(o),E=[0,0,0],v=[0,0,0];for(let l=0;l<i;l++){for(let h=0;h<s;h++){x(h,l,E),b(h,l,v);const w=l*s+h;R[w]=kr(E[0],E[1],E[2]),A[w]=kr(v[0],v[1],v[2])}(l+1)%or===0&&await Gn()}return ys(R,A,s,i)}async function Vs(e,t,r,n,a){return t.scalars?t.scalars:(t.scalarsPending||(t.scalarsPending=hn(e,r,n,a).then(s=>(t.scalars=s,s))),t.scalarsPending)}async function Nn(e,t){return t.resultSamples?t.resultSamples:(t.resultSamplesPending||(t.resultSamplesPending=e.readback(t.texture).then(r=>{const n=r instanceof Float32Array?r:Float32Array.from(r);return t.resultSamples=n,lr(e).accountReadbackBytes(t,n.byteLength),n})),t.resultSamplesPending)}function $s(e){return lr(e).size}const Hs=`
${ge}
${qe}
...
`,Ws={unit:0,signed:1,relative:2},Ks={linear:0,signed:1,positive:2};function qs(e,t){if(t){if(t.length!==256*4)throw new Error(`renderDiffDisplay: colormap must be 256*4 floats, got ${t.length}`);const n=e.createTexture(256,1,"rgba32float");return n.write(t),n}const r=e.createTexture(1,1,"rgba32float");return r.write(new Float32Array([0,0,0,1])),r}function Ys(e){return"canvas"in e?e.hdr?"rgba16float":"rgba8unorm":e.format}function Xs(e,t,r,n,a){var x,b,R;const s=Ys(t),i=cr(e,"diff-display",Hs,s),o=qs(e,a.colormap),u=new Float32Array([a.uv.x,a.uv.y,a.uv.w,a.uv.h]),c=new Float32Array([Ws[n],Ks[a.cmapMode??"positive"],a.colormap?1:0,a.filter==="nearest"?0:1]),f=new Float32Array([a.exposureEV??0,a.offset??0,0,0]),g=new Float32Array([((x=a.sourceDims)==null?void 0:x.w)??0,((b=a.sourceDims)==null?void 0:b.h)??0,0,0]);let p;try{p=e.createBindGroup(i,[{binding:0,resource:r},{binding:1,resource:o},{binding:2,resource:{uniform:u}},{binding:3,resource:{uniform:c}},{binding:4,resource:{uniform:f}},{binding:5,resource:{uniform:g}}]),e.renderFullscreen(t,i,p)}finally{(R=p==null?void 0:p.destroy)==null||R.call(p),o.destroy()}}const Hr=.6*.6*2.51,js=.6*.03,Zs=0,Wr=.6*.6*2.43,Qs=.6*.59,Js=.14;function Kr(e){const t=(js-Qs*e)/(Hr-Wr*e),r=(Zs-Js*e)/(Hr-Wr*e);return-.5*t+Math.sqrt((.5*t)**2-r)}const ei=.85,ti=.85,qr=11920928955078125e-23,er=[.2126,.7152,.0722];function ri(e,t,r){const n=t*r;if(r===1){const a=e[n];return[a,a,a]}return[e[n],e[n+1],e[n+2]]}function ni(e,t,r,n=3,a={}){const s=t*r,i=Kr(ei),o=Kr(ti),u=new Float64Array(s);let c=0;for(let v=0;v<s;v++){const[l,h,w]=ri(e,v,n),y=l*er[0]+h*er[1]+w*er[2];u[v]=y,y>c&&(c=y)}const f=Float64Array.from(u).sort(),g=s>>1,p=s%2===1?f[g]:f[g-1],x=Math.max(p,qr),b=Math.max(c,qr),R=a.startExposure??Math.log2(i/b),A=a.stopExposure??Math.log2(o/x),E=Math.max(2,Math.ceil(A-R));return{startExposure:R,stopExposure:A,numExposures:E}}function ai(e){const t=fa(e),r=new Float32Array(256*4);for(let n=0;n<256;n++)r[n*4+0]=t[n*3+0]/255,r[n*4+1]=t[n*3+1]/255,r[n*4+2]=t[n*3+2]/255,r[n*4+3]=1;return r}function si(e){const{width:t,height:r,channels:n}=e,a=t*r;if(e.precision==="f16-bits"){const u=e.data,c=new Uint16Array(a*4);for(let f=0;f<a;f++){const g=f*n,p=f*4;if(n===1){const x=u[g];c[p]=x,c[p+1]=x,c[p+2]=x,c[p+3]=At}else c[p]=u[g],c[p+1]=u[g+1],c[p+2]=u[g+2],c[p+3]=n>=4?u[g+3]:At}return{data:c,format:"rgba16float"}}const s=e.data,i=new Float32Array(a*4),o=u=>Number.isFinite(u)?u:0;for(let u=0;u<a;u++){const c=u*n;let f,g,p,x=1;n===1?f=g=p=o(s[c]):n===3?(f=o(s[c]),g=o(s[c+1]),p=o(s[c+2])):(f=o(s[c]),g=o(s[c+1]),p=o(s[c+2]),x=o(s[c+3]));const b=u*4;i[b]=f,i[b+1]=g,i[b+2]=p,i[b+3]=x}return{data:i,format:"rgba32float"}}function ii({imageUrl:e,baselineUrl:t,imageFloat:r,baselineFloat:n,mode:a,splitPosition:s,blendAlpha:i,onSplitPositionChange:o,diffSubmode:u,colormap:c="none",align:f="top-left",fit:g="crop",diffKernel:p,onDiffKernelChange:x,onCompareModeChange:b,onRequestSide:R,zoom:A,pan:E,onViewportChange:v,interpolation:l="auto",label:h="",pixelValueNotation:w="decimal",tonemap:y,peak:S,gamma:k,toolbar:G=!0}){var hr;const B=d.useRef(null),L=d.useRef(null),K=d.useRef(null),F=d.useRef(null),Y=d.useRef(null),[te,ue]=d.useState(!1),[j,J]=d.useState(!1),H=d.useRef(!1),[se,ee]=d.useState(!1),[oe,Se]=d.useState(null),[ne,Ie]=d.useState(null),[_e,It]=d.useState({a:!1,b:!1}),[Ye,Xe]=d.useState(0),[gt,nt]=d.useState(0),[Pe,at]=d.useState(null),[le,De]=d.useState(null),[Ne,ht]=d.useState({x:0,y:0,w:1,h:1}),Be=p??u??"absolute",[ve,he,st]=Oe(Be);d.useEffect(()=>{he(p??u??"absolute")},[p,u,he]);const ye=d.useCallback(m=>{he(m),x==null||x(m)},[x,he]);d.useEffect(()=>{const m=B.current;if(m)return m.__cairnDiffKernel={current:ve,set:ye},()=>{m&&delete m.__cairnDiffKernel}},[ve,ye]);const[X,ze,Ae]=Oe(a);d.useEffect(()=>{ze(a)},[a,ze]);const xe=d.useCallback(m=>{ze(m),b==null||b(m)},[b,ze]),[be,Le,je]=Oe(c);d.useEffect(()=>{Le(c)},[c,Le]);const[Ze,it]=d.useState(null);d.useEffect(()=>{it(null)},[y]);const Ve=un(y),fe=Ze??Ve,Nt=Ze!==null&&Ze!==Ve,xt=()=>S!=null&&S>0?S:ln(y)??Ot,[ot,ct,Qe]=Oe(xt()),[Je,T,C]=Oe(k&&k>0?k:Yr);d.useEffect(()=>{ct(xt())},[S,y]),d.useEffect(()=>{k&&k>0&&T(k)},[k,T]);const V=d.useCallback(()=>{xe(Ae.default),Le(je.default),ye(st.default),it(null),Qe.reset(),C.reset()},[xe,Le,ye,Ae.default,je.default,st.default,Qe,C]),D=Ae.isModified||je.isModified||st.isModified||Nt||Qe.isModified||C.isModified,[I,z]=d.useState(0),[re,ie]=d.useState(0),de=d.useMemo(()=>{const P=[da({mode:X,kernel:ve,kernelOptions:Un().map(_=>({id:_.id,label:_.label})),onSide:R,onSlide:()=>xe("split"),onBlend:()=>xe("blend"),onKernel:_=>{xe("diff"),ye(_)}})];return X==="diff"?P.push(nr(be,_=>Le(_))):P.push(rr(fe,_=>it(_))),P},[X,ve,be,fe,ye,xe,R]),W=d.useRef(null),we=d.useRef(null),$e=d.useRef(null),He=d.useRef(null),[et,We]=d.useState(0),Ke=d.useRef(null),Te=d.useRef(null),[zn,fr]=d.useState(0),zt=Xr();d.useEffect(()=>{const m=K.current;if(!m)return;let P=!1;return Ut().then(_=>{var M;if(!P)try{if(xn())throw new Error("cairn-plot engine: forced compare-pane activation failure (?forceEngineFail test hook)");const O=((M=_.probeExtendedToneMapping)==null?void 0:M.call(_))??!1,N=typeof matchMedia<"u"&&matchMedia("(dynamic-range: high)").matches,q=O&&N;H.current=q,ee(q);const Z=_.createSurface(m,{hdr:q});F.current={device:_,surface:Z,texA:null,texB:null},J(!0)}catch(O){console.warn("cairn-plot: GpuComparePane failed to activate, falling back to legacy pane",O),ue(!0)}}).catch(_=>{P||(console.warn("cairn-plot: GpuComparePane could not resolve a GPU device, falling back to legacy pane",_),ue(!0))}),()=>{var M,O;P=!0;const _=F.current;_&&((M=_.texA)==null||M.destroy(),(O=_.texB)==null||O.destroy(),F.current=null)}},[]),d.useEffect(()=>{const m=B.current;if(!m)return;const P=new ResizeObserver(()=>nt(_=>_+1));return P.observe(m),()=>P.disconnect()},[]),d.useEffect(()=>{if(!j)return;let m=!1;if(!F.current)return;async function _(M,O){if(O){const q=si(O);return{width:O.width,height:O.height,imageData:null,make:Z=>{const $=Z.createTexture(O.width,O.height,q.format);return $.write(q.data),$}}}if(!M)return null;const N=await jr(M);return N?{width:N.width,height:N.height,imageData:N,make:q=>{const Z=q.createTexture(N.width,N.height,"rgba8unorm");return Z.write(N.data),Z}}:null}return Promise.all([_(e,r),_(t,n)]).then(([M,O])=>{var ae,me;if(m||!F.current)return;const N=F.current;W.current=(M==null?void 0:M.imageData)??null,we.current=(O==null?void 0:O.imageData)??null,$e.current=r??null,He.current=n??null,(ae=N.texA)==null||ae.destroy(),(me=N.texB)==null||me.destroy(),N.texA=null,N.texB=null;const q=M??O;if(!q){Se(null),Ie(null),We(Ce=>Ce+1);return}const Z=O??q,$=M??q;N.texA=Z.make(N.device),N.texB=$.make(N.device),Ie({a:{w:Z.width,h:Z.height},b:{w:$.width,h:$.height}}),It({a:Z.imageData!=null,b:$.imageData!=null}),Se({w:q.width,h:q.height}),We(Ce=>Ce+1),Xe(Ce=>Ce+1)}),()=>{m=!0}},[j,e,t,r,n]);const bt=r!=null||n!=null,pe=d.useMemo(()=>Ts(ve,bt),[ve,bt]),ut=d.useMemo(()=>{if(!bt)return null;const m=n??r;if(!m)return null;const P=m.precision==="f16-bits"?aa(m.data):m.data;return ni(P,m.width,m.height,m.channels)},[bt,n,r]),dr=d.useMemo(()=>{var m;return sa(((m=Ue(pe))==null?void 0:m.displayRange)??"unit",be==="none"?null:be)},[pe,be]),pr=d.useMemo(()=>be!=="none"?ai(be):void 0,[be]),Me=d.useMemo(()=>ne?mt(ne.a,ne.b,f,g,"b"):null,[ne,f,g]),Vn=d.useMemo(()=>Me?ur(Me):"none",[Me]),vt=(n==null?void 0:n.contentKey)??t??(r==null?void 0:r.contentKey)??e??"none",yt=(r==null?void 0:r.contentKey)??e??(n==null?void 0:n.contentKey)??t??"none",ce=oe,Vt=d.useCallback(()=>{const m=F.current;if(!j||!m||!m.surface||!m.texA||!m.texB||!oe)return;const P=ce??oe,_=B.current,M=_?_.getBoundingClientRect():{width:P.w,height:P.h},O=Rn({zoom:A,pan:E},M,P.w,P.h);ht($=>$.x===O.x&&$.y===O.y&&$.w===O.w&&$.h===O.h?$:O);const N=K.current;if(M.width>0&&M.height>0&&N&&m.surface){const $=Math.max(1,Math.round(M.width*zt)),ae=Math.max(1,Math.round(M.height*zt));(N.width!==$||N.height!==ae)&&(N.width=$,N.height=ae,m.surface.configure($,ae))}const q=Sn(O,M,P.w,P.h)>=Zr?"nearest":"linear",Z=O;try{if(X==="diff"){const $=Ue(pe)?pe:"absolute",ae=$==="hdr-flip"&&ut?{ppd:67,startExposure:ut.startExposure,stopExposure:ut.stopExposure,numExposures:ut.numExposures}:void 0,me=In(m.device,m.texA,m.texB,$,ae,vt,yt,Me??void 0);Y.current=me,Xs(m.device,m.surface,me.texture,me.displayRange,{uv:Z,cmapMode:dr,colormap:pr,filter:q,sourceDims:P,exposureEV:I,offset:re})}else{const $=Qr(fe,H.current?ot:1,H.current,Je),ae={exposureEV:I,offset:re,operator:$.operator,gamma:$.gamma,isScalar:!1,hdrOut:$.hdrOut,peak:$.peak,srgbDecodeA:_e.a,srgbDecodeB:_e.b,uv:Z,filter:q,mode:X,split:s,alpha:i};Ua(m.device,m.surface,m.texA,m.texB,ae)}}catch($){console.warn("cairn-plot: GpuComparePane render failed, falling back to legacy pane",$),ue(!0)}},[j,oe,ce,Me,A,E.x,E.y,X,s,i,I,re,fe,ot,Je,_e,ve,pe,ut,dr,pr,e,t,r,n,vt,yt,zt]);d.useEffect(()=>{Vt()},[Vt,Ye,gt]);const tt=t!=null||n!=null;d.useEffect(()=>{const m=F.current;if(!j||!m||!m.texA||!m.texB||!tt){at(null);return}let P=!1;const _=m.texA,M=m.texB,O=Y.current,N=X==="diff"?Me??void 0:void 0;return(X==="diff"&&O?Vs(m.device,O,_,M,N):hn(m.device,_,M,N)).then(Z=>{P||at(Z)}),()=>{P=!0}},[j,Ye,tt,X,ve,Me]),d.useEffect(()=>{const m=F.current;if(!j||!m||!m.texA||!m.texB||!tt){De(null);return}let P=!1;De(null);const _=X==="diff"?Me??void 0:void 0;return Is(m.device,m.texA,m.texB,vt,yt,_).then(M=>{P||De(M)}).catch(()=>{P||De(null)}),()=>{P=!0}},[j,Ye,tt,X,Vn,vt,yt]),d.useEffect(()=>{if(X!=="diff"){Ke.current=null,Te.current=null;return}const m=F.current,P=Y.current;if(!j||!m||!P)return;let _=!1;return Ke.current=null,Te.current=null,fr(M=>M+1),Nn(m.device,P).then(M=>{_||(Ke.current=M,Te.current={w:P.width,h:P.height},fr(O=>O+1))}).catch(()=>{}),()=>{_=!0}},[j,X,pe,Ye,Me]);const mr=(m,P)=>(_,M,O)=>{const N=P.current;if(N){const{data:Ce,width:xr,height:Kn,channels:br}=N;if(_<0||M<0||_>=xr||M>=Kn)return null;const Et=(M*xr+_)*br,Rt=N.precision==="f16-bits"?Wt=>Jr(Ce[Wt]??0):Wt=>Ce[Wt]??0,qn=br===1?[Rt(Et)]:[Rt(Et),Rt(Et+1),Rt(Et+2)];return ft(qn,"unit",O)}const q=m.current;if(!q||_<0||M<0||_>=q.width||M>=q.height)return null;const Z=(M*q.width+_)*4,$=q.data[Z],ae=q.data[Z+1],me=q.data[Z+2];return ft($===ae&&ae===me?[$]:[$,ae,me],"uint8",O)},wt=d.useMemo(()=>mr(W,$e),[]),$t=d.useMemo(()=>mr(we,He),[]),Ht=d.useMemo(()=>(m,P,_)=>{var me;const M=Ke.current,O=Te.current;if(!M||!O)return null;const{w:N,h:q}=O;if(m<0||P<0||m>=N||P>=q)return null;const Z=(P*N+m)*4,ae=(((me=Ue(pe))==null?void 0:me.output)??"per-channel")==="scalar"?[M[Z]??0]:[M[Z]??0,M[Z+1]??0,M[Z+2]??0];return ft(ae,"unit",_)},[pe]);d.useEffect(()=>{const m=B.current;if(m)return m.__cairnCompareProbe={sampleDiff:(P,_,M="decimal")=>Ht(P,_,M),sampleFg:(P,_,M="decimal")=>wt(P,_,M),sampleRef:(P,_,M="decimal")=>$t(P,_,M),get diffSamples(){return Ke.current},get dims(){return ce},get primaryDims(){return oe},get diffResultDims(){return Te.current},get align(){return f},get fit(){return g},get resolvedKernelId(){return pe},get compareMode(){return X},computeCount:()=>ks(),cacheSize:()=>F.current?$s(F.current.device):0,get ssimScalar(){return le},get ssimText(){return zr(le)},get effectiveTonemap(){return fe},get hdrEngaged(){return se}},()=>{m&&delete m.__cairnCompareProbe}},[Ht,wt,$t,oe,ce,f,g,pe,X,le,fe,se]);const $n=l==="auto"?void 0:l;if(te)return r!=null||n!=null?Q.jsx(ia,{}):X==="diff"?Q.jsx(tr,{toolbar:G,imageUrl:e,baselineUrl:t,diffMode:((hr=Ue(pe))==null?void 0:hr.kind)==="pointwise"?pe:"absolute",interpolation:l,colormap:be,showAxes:!1,zoom:A,pan:E,onViewportChange:v,label:h,pixelValueNotation:w}):Q.jsx(oa,{imageUrl:e,baselineUrl:t,mode:X,splitPosition:s,blendAlpha:i,onSplitPositionChange:o,zoom:A,pan:E,onViewportChange:v,interpolation:l,label:h,pixelValueNotation:w});const Hn=Q.jsxs(Q.Fragment,{children:[Q.jsx("canvas",{ref:K,className:"w-full h-full block",style:{imageRendering:$n},"data-gpu-compare-canvas":!0}),X==="split"&&Q.jsx(la,{splitPosition:s,onChange:o,onReset:()=>o==null?void 0:o(.5)})]}),gr=!!h,Wn=gr?"bottom-7":"bottom-1";return Q.jsx(en,{paneAttrs:{"data-gpu-compare-pane":"","data-gpu-compare-ready":j},viewportAttrs:{"data-gpu-compare-viewport":""},toolbar:G,paneRef:B,wrapperRef:L,zoom:A,pan:E,onViewportChange:v,naturalDims:ce,checkerboard:"pane",wrapperClassName:"relative w-full h-full flex items-center justify-center",viewportPadding:0,surface:Hn,showAxes:!1,notationSeed:w,onReset:V,extraModified:D,exportCanvasRef:K,requestRender:Vt,leadingMenus:de,displayAdjust:{exposureEV:I,offset:re,onExposureChange:z,onOffsetChange:ie},extraSliders:[...se&&X!=="diff"?[{id:"peak",label:"PK",title:"Peak white (×SDR white) — the HDR ceiling P every operator clips at (Linear/sRGB/Gamma hard-clip at P; Reinhard/ACES roll off toward P). P=1 reproduces the SDR rendition exactly; double-click to type a value, including 'inf' for the raw browser-clipped extended look.",min:nn,max:rn,step:tn,value:ot,onChange:ct,format:m=>Number.isFinite(m)?`${m.toFixed(1)}×`:"∞"}]:[],...X!=="diff"&&cn(fe)?[{id:"gamma",label:"γ",title:"Display gamma γ for the Gamma transfer — display = clamp(value)^(1/γ), tev-style. Default 2.2 (close to sRGB, not identical). Double-click to type a value.",min:on,max:sn,step:an,value:Je,onChange:T,format:m=>m.toFixed(1)}]:[]],label:"",showLabelChip:!1,overlay:{render:({notation:m,setOverlayActive:P})=>X==="split"?Q.jsxs(Q.Fragment,{children:[tt&&ce&&Q.jsx("div",{className:"absolute inset-0 overflow-hidden pointer-events-none",style:{clipPath:`inset(0 ${(1-s)*100}% 0 0)`},children:Q.jsx(Kt,{imageElRef:K,naturalWidth:ce.w,naturalHeight:ce.h,zoom:A,pan:E,sourceWindow:Ne,sample:$t,notation:m,version:et})}),tt&&ce&&Q.jsx("div",{className:"absolute inset-0 overflow-hidden pointer-events-none",style:{clipPath:`inset(0 0 0 ${s*100}%)`},children:Q.jsx(Kt,{imageElRef:K,naturalWidth:ce.w,naturalHeight:ce.h,zoom:A,pan:E,sourceWindow:Ne,sample:wt,notation:m,version:et,onActiveChange:P})})]}):ce&&Q.jsx(Kt,{imageElRef:K,naturalWidth:ce.w,naturalHeight:ce.h,zoom:A,pan:E,sourceWindow:Ne,sample:X==="diff"?Ht:wt,notation:m,version:X==="diff"?zn:et,onActiveChange:P})},extraChips:Q.jsxs(Q.Fragment,{children:[X==="split"&&Q.jsx(ca,{}),gr?Q.jsx(ua,{label:h,corner:"bottom-right"}):null,Pe&&Q.jsxs("span",{className:`absolute right-1 z-30 rounded bg-bg/80 px-1 py-0.5 text-[10px] text-fg-muted backdrop-blur-sm font-mono ${Wn}`,"data-gpu-compare-metrics":!0,children:["MSE ",Pe.mse.toExponential(2)," · PSNR ",Number.isFinite(Pe.psnr)?Pe.psnr.toFixed(1):"∞"," dB · MAE"," ",Pe.mae.toExponential(2)," · SSIM ",zr(le)]})]})})}const oi="cairn-plot:gpu-image-ready";async function ci(){if(!window.__cairnPlotGpuImageLoaded){if(window.__cairnPlotUseGpuImage===!1){console.info("cairn-plot gpu-image addon: skipped (__cairnPlotUseGpuImage === false)");return}try{await Ut(),window.__cairnPlotGpuImagePane=Qa,window.__cairnPlotGpuComparePane=ii,window.__cairnPlotDiffMenuModes=Un(),window.__cairnPlotUseGpuImage=!0,window.__cairnPlotGpuImageLoaded=!0,window.dispatchEvent(new Event(oi))}catch(e){console.warn("cairn-plot gpu-image addon: engine init failed, staying on legacy panes",e),En("no-webgpu")}}}ci();
